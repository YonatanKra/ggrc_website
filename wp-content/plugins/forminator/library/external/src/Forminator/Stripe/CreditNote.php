 ...
 * @property string|\Forminator\Stripe\Customer $customer ID of the customer.
 * @property null|string|\Forminator\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \Forminator\Stripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\Forminator\Stripe\Invoice $invoice ID of the invoice.
 * @property \Forminator\Stripe\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\Forminator\Stripe\Refund $refund Refund related to this credit note.
 ...
 * @property \Forminator\Stripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \Forminator\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \Forminator\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Forminator\Stripe\Collection the list of credit note line items
     */
