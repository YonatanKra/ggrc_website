 ...
 * @property null|\Forminator\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\Forminator\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \Forminator\Stripe\StripeObject $dob
 ...
 * @property \Forminator\Stripe\StripeObject $relationship
 * @property null|\Forminator\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \Forminator\Stripe\StripeObject $verification
 */
