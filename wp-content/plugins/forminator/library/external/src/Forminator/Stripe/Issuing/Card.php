 ...
 * @property null|string|\Forminator\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\Forminator\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\Forminator\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \Forminator\Stripe\StripeObject $spending_controls
...
class Card extends \Forminator\Stripe\ApiResource
{
     ...
     *
     * @return \Forminator\Stripe\Issuing\CardDetails the card details associated with that issuing card
     */
