 ...
 * @property \Forminator\Stripe\StripeObject $ach_debit
 * @property \Forminator\Stripe\StripeObject $acss_debit
 * @property \Forminator\Stripe\StripeObject $alipay
 ...
 * @property \Forminator\Stripe\StripeObject $au_becs_debit
 * @property \Forminator\Stripe\StripeObject $bancontact
 * @property \Forminator\Stripe\StripeObject $card
 * @property \Forminator\Stripe\StripeObject $card_present
 * @property string $client_secret The client secret of the source. Used for client-side retrieval using a publishable key.
 * @property \Forminator\Stripe\StripeObject $code_verification
 ...
 * @property \Forminator\Stripe\StripeObject $eps
 ...
 * @property \Forminator\Stripe\StripeObject $giropay
 * @property \Forminator\Stripe\StripeObject $ideal
 * @property \Forminator\Stripe\StripeObject $klarna
 ...
 * @property \Forminator\Stripe\StripeObject $multibanco
 * @property null|\Forminator\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \Forminator\Stripe\StripeObject $p24
 * @property \Forminator\Stripe\StripeObject $receiver
 * @property \Forminator\Stripe\StripeObject $redirect
 * @property \Forminator\Stripe\StripeObject $sepa_credit_transfer
 * @property \Forminator\Stripe\StripeObject $sepa_debit
 * @property \Forminator\Stripe\StripeObject $sofort
 * @property \Forminator\Stripe\StripeObject $source_order
 ...
 * @property \Forminator\Stripe\StripeObject $three_d_secure
 ...
 * @property \Forminator\Stripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \Forminator\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \Forminator\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Forminator\Stripe\Source the detached source
     */
     ...
     * @throws \Forminator\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Forminator\Stripe\Collection the list of source transactions
     */
