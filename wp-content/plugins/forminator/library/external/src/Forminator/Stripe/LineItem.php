 ...
 * @property \Forminator\Stripe\StripeObject[] $discounts The discounts applied to the line item.
 ...
 * @property \Forminator\Stripe\StripeObject[] $taxes The taxes applied to the line item.
 */
