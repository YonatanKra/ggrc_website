 ...
 * @property null|string|\Forminator\Stripe\Customer $customer ID of the customer.
 ...
 * @property null|\Forminator\Stripe\StripeObject $verification Tax ID verification information.
 */
