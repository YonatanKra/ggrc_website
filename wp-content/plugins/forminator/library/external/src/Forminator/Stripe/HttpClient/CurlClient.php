...
class CurlClient implements ClientInterface
{
    ...
    /** @var \Forminator\Stripe\Util\RandomGenerator */
     ...
     * @param null|\Forminator\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\Forminator\Stripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\Forminator\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */
