 ...
 * @property \Forminator\Stripe\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\Forminator\Stripe\Customer $customer The ID of the customer associated with this discount.
