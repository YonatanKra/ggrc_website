 ...
 * @property \Forminator\Stripe\StripeObject $data
 ...
 * @property null|\Forminator\Stripe\StripeObject $request Information on the API request that instigated the event.
