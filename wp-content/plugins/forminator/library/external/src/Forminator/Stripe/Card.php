 ...
 * @property null|string|\Forminator\Stripe\Account $account The account this card belongs to. This attribute will not be in the card object if the card belongs to a customer or recipient instead.
 ...
 * @property null|string|\Forminator\Stripe\Customer $customer The customer that this card belongs to. This attribute will not be in the card object if the card belongs to an account or recipient instead.
 ...
 * @property null|string|\Forminator\Stripe\Recipient $recipient The recipient that this card belongs to. This attribute will not be in the card object if the card belongs to a customer or account instead.
...
class Card extends ApiResource
{
     ...
     *
     * @throws \Forminator\Stripe\Exception\BadMethodCallException
     */
