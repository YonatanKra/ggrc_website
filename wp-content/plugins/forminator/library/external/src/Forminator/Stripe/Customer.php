 ...
 * @property null|\Forminator\Stripe\StripeObject $address The customer's address.
 ...
 * @property null|\Forminator\Stripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \Forminator\Stripe\StripeObject $invoice_settings
 ...
 * @property null|\Forminator\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \Forminator\Stripe\Collection $sources The customer's payment sources, if any.
 * @property \Forminator\Stripe\Collection $subscriptions The customer's current subscriptions, if any.
 ...
 * @property \Forminator\Stripe\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \Forminator\Stripe\Customer the updated customer
     */
     ...
     *
     * @return \Forminator\Stripe\Collection the list of customer balance transactions
     */
     ...
     * @throws \Forminator\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Forminator\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \Forminator\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Forminator\Stripe\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \Forminator\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Forminator\Stripe\AlipayAccount|\Forminator\Stripe\BankAccount|\Forminator\Stripe\BitcoinReceiver|\Forminator\Stripe\Card|\Forminator\Stripe\Source
     */
     ...
     * @throws \Forminator\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Forminator\Stripe\Collection the list of tax ids
     */
     ...
     * @throws \Forminator\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \Forminator\Stripe\TaxId
     */
