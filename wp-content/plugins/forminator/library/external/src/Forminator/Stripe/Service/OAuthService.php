...
class OAuthService extends \Forminator\Stripe\Service\AbstractService
{
     ...
     * @param null|array $opts
     *
     * @throws \Forminator\Stripe\Exception\OAuth\OAuthErrorException if the request fails
     *
    ...
    private function _getClientId($params = null)
    {
        ...
        if (null === $clientId) {
            $msg = 'No client_id provided. (HINT: set your client_id using '
              . '`new \Forminator\Stripe\StripeClient([clientId => <CLIENT-ID>
     ...
     *
     * @return \Forminator\Stripe\Util\RequestOptions
     */
