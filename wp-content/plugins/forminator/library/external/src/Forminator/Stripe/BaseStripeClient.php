...
class BaseStripeClient implements StripeClientInterface
{
    ...
    /** @var \Forminator\Stripe\Util\RequestOptions */
    private $defaultOpts;
    ...
    public function __construct($config = [])
    {
        ...
        $this->defaultOpts = \Forminator\Stripe\Util\RequestOptions::parse([
    ...
    public function requestCollection($method, $path, $params, $opts)
    {
        ...
        if (!($obj instanceof \Forminator\Stripe\Collection)) {
            ...
            $msg = "Expected to receive `Forminator\Stripe\\Collection` object from Stripe API. Instead received `{$received_class}`.";
    ...
    /**
     * @param \Forminator\Stripe\Util\RequestOptions $opts
     *
     * @throws \Forminator\Stripe\Exception\AuthenticationException
     *
     * @return string
     */
