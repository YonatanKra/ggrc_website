 ...
 * @property \Forminator\Stripe\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\Forminator\Stripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\Forminator\Stripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\Forminator\Stripe\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\Forminator\Stripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\Forminator\Stripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\Forminator\Stripe\StripeObject $total_details Tax and discount details for the computed total amount.
 */
class Session extends \Forminator\Stripe\ApiResource
{
     ...
     *
     * @return \Forminator\Stripe\Collection the list of items
     */
