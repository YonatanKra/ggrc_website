...
class Forminator_Quizzes extends Forminator_Module {
	...
	public function options() {
		return array(
			...
			'singular_name' => __( 'Quiz', 'forminator' ),
			'description'   => __( 'Create fun quizzes for your users to take and share on social media. A great way to drive more traffic to your site.', 'forminator' ),
			'button_label'  => __( 'New Quiz', 'forminator' ),
