...
/**
 * Class Forminator_Addon_Trello_Form_Settings_Exception
 * Wrapper of Form Settings Trello Exception
 *
 * @since 1.0 Trello Addon
 */
class Forminator_Addon_Trello_Form_Settings_Exception extends Forminator_Addon_Trello_Exception {
	...
	/**
	 * Forminator_Addon_Trello_Form_Settings_Exception constructor.
	 *
