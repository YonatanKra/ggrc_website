 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Dns extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->changes = new Forminator_Google_Service_Dns_Changes_Resource(
        $this,
        $this->serviceName,
        'changes',
        array(
    ...
    $this->managedZones = new Forminator_Google_Service_Dns_ManagedZones_Resource(
        $this,
        $this->serviceName,
        'managedZones',
        array(
    ...
    $this->projects = new Forminator_Google_Service_Dns_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->resourceRecordSets = new Forminator_Google_Service_Dns_ResourceRecordSets_Resource(
        $this,
        $this->serviceName,
        'resourceRecordSets',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $dnsService = new Forminator_Google_Service_Dns(...);
 *   $changes = $dnsService->changes;
 *  </code>
 */
class Forminator_Google_Service_Dns_Changes_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param Forminator_Google_Change $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Dns_Change
   */
  public function create($project, $managedZone, Forminator_Google_Service_Dns_Change $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Dns_Change");
  }
  ...
  public function get($project, $managedZone, $changeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Dns_Change");
  }
   ...
   * 'descending'.
   * @return Forminator_Google_Service_Dns_ChangesListResponse
   */
  public function listChanges($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Dns_ChangesListResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Dns_ManagedZones_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param string $project Identifies the project addressed by this request.
   * @param Forminator_Google_ManagedZone $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Dns_ManagedZone
   */
  public function create($project, Forminator_Google_Service_Dns_ManagedZone $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Dns_ManagedZone");
  }
  ...
  public function get($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Dns_ManagedZone");
  }
   ...
   * request that was truncated. Use this parameter to continue a previous list
   * request.
   * @return Forminator_Google_Service_Dns_ManagedZonesListResponse
   */
  public function listManagedZones($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Dns_ManagedZonesListResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Dns_Projects_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $project Identifies the project addressed by this request.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Dns_Project
   */
  public function get($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Dns_Project");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Dns_ResourceRecordSets_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Dns_ResourceRecordSetsListResponse
   */
  public function listResourceRecordSets($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Dns_ResourceRecordSetsListResponse");
  }
}
...
class Forminator_Google_Service_Dns_Change extends Forminator_Google_Collection
{
  protected $collection_key = 'deletions';
  protected $internal_gapi_mappings = array(
  );
  protected $additionsType = 'Forminator_Google_Service_Dns_ResourceRecordSet';
  protected $additionsDataType = 'array';
  protected $deletionsType = 'Forminator_Google_Service_Dns_ResourceRecordSet';
...
class Forminator_Google_Service_Dns_ChangesListResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'changes';
  protected $internal_gapi_mappings = array(
  );
  protected $changesType = 'Forminator_Google_Service_Dns_Change';
...
class Forminator_Google_Service_Dns_ManagedZone extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Dns_ManagedZonesListResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'managedZones';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $managedZonesType = 'Forminator_Google_Service_Dns_ManagedZone';
...
class Forminator_Google_Service_Dns_Project extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
  public $kind;
  public $number;
  protected $quotaType = 'Forminator_Google_Service_Dns_Quota';
  ...
  public function setQuota(Forminator_Google_Service_Dns_Quota $quota)
  {
    $this->quota = $quota;
  }
...
class Forminator_Google_Service_Dns_Quota extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Forminator_Google_Service_Dns_ResourceRecordSet extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Dns_ResourceRecordSetsListResponse extends Forminator_Google_Collection
{
  ...
  public $kind;
  public $nextPageToken;
  protected $rrsetsType = 'Forminator_Google_Service_Dns_ResourceRecordSet';
