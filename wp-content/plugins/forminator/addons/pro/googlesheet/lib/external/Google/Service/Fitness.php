 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Fitness extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->users_dataSources = new Forminator_Google_Service_Fitness_UsersDataSources_Resource(
        $this,
        $this->serviceName,
        'dataSources',
        array(
    ...
    $this->users_dataSources_datasets = new Forminator_Google_Service_Fitness_UsersDataSourcesDatasets_Resource(
        $this,
        $this->serviceName,
        'datasets',
        array(
    ...
    $this->users_dataset = new Forminator_Google_Service_Fitness_UsersDataset_Resource(
        $this,
        $this->serviceName,
        'dataset',
        array(
    ...
    $this->users_sessions = new Forminator_Google_Service_Fitness_UsersSessions_Resource(
        $this,
        $this->serviceName,
        'sessions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $fitnessService = new Forminator_Google_Service_Fitness(...);
 *   $users = $fitnessService->users;
 *  </code>
 */
class Forminator_Google_Service_Fitness_Users_Resource extends Forminator_Google_Service_Resource
{
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Fitness_UsersDataSources_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param Forminator_Google_DataSource $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Fitness_DataSource
   */
  public function create($userId, Forminator_Google_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Fitness_DataSource");
  }
  ...
  public function delete($userId, $dataSourceId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Forminator_Google_Service_Fitness_DataSource");
  }
  ...
  public function get($userId, $dataSourceId, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Fitness_DataSource");
  }
   ...
   * @return Forminator_Google_Service_Fitness_ListDataSourcesResponse
   */
  public function listUsersDataSources($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Fitness_ListDataSourcesResponse");
  }
   ...
   * @return Forminator_Google_Service_Fitness_DataSource
   */
  public function patch($userId, $dataSourceId, Forminator_Google_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Fitness_DataSource");
  }
   ...
   * @return Forminator_Google_Service_Fitness_DataSource
   */
  public function update($userId, $dataSourceId, Forminator_Google_Service_Fitness_DataSource $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Fitness_DataSource");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Fitness_UsersDataSourcesDatasets_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Fitness_Dataset
   */
  public function get($userId, $dataSourceId, $datasetId, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Fitness_Dataset");
  }
   ...
   * @return Forminator_Google_Service_Fitness_Dataset
   */
  public function patch($userId, $dataSourceId, $datasetId, Forminator_Google_Service_Fitness_Dataset $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'dataSourceId' => $dataSourceId, 'datasetId' => $datasetId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Fitness_Dataset");
  }
}
/**
 ...
 *  </code>
 */
class Forminator_Google_Service_Fitness_UsersDataset_Resource extends Forminator_Google_Service_Resource
{
   ...
   * indicate the authenticated user. Only me is supported at this time.
   * @param Forminator_Google_AggregateRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Fitness_AggregateResponse
   */
  public function aggregate($userId, Forminator_Google_Service_Fitness_AggregateRequest $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('aggregate', array($params), "Forminator_Google_Service_Fitness_AggregateResponse");
  }
}
/**
 ...
 *  </code>
 */
class Forminator_Google_Service_Fitness_UsersSessions_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Fitness_ListSessionsResponse
   */
  public function listUsersSessions($userId, $optParams = array())
  {
    $params = array('userId' => $userId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Fitness_ListSessionsResponse");
  }
   ...
   * @param Forminator_Google_Session $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string currentTimeMillis The client's current time in milliseconds
   * since epoch.
   * @return Forminator_Google_Service_Fitness_Session
   */
  public function update($userId, $sessionId, Forminator_Google_Service_Fitness_Session $postBody, $optParams = array())
  {
    $params = array('userId' => $userId, 'sessionId' => $sessionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Fitness_Session");
  }
}
...
class Forminator_Google_Service_Fitness_AggregateBucket extends Forminator_Google_Collection
{
  protected $collection_key = 'dataset';
  protected $internal_gapi_mappings = array(
  );
  public $activity;
  protected $datasetType = 'Forminator_Google_Service_Fitness_Dataset';
  protected $datasetDataType = 'array';
  public $endTimeMillis;
  protected $sessionType = 'Forminator_Google_Service_Fitness_Session';
  ...
  public function setSession(Forminator_Google_Service_Fitness_Session $session)
  {
...
class Forminator_Google_Service_Fitness_AggregateBy extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dataSourceId;
...
class Forminator_Google_Service_Fitness_AggregateRequest extends Forminator_Google_Collection
{
  protected $collection_key = 'aggregateBy';
  protected $internal_gapi_mappings = array(
  );
  protected $aggregateByType = 'Forminator_Google_Service_Fitness_AggregateBy';
  protected $aggregateByDataType = 'array';
  protected $bucketByActivitySegmentType = 'Forminator_Google_Service_Fitness_BucketByActivity';
  protected $bucketByActivitySegmentDataType = '';
  protected $bucketByActivityTypeType = 'Forminator_Google_Service_Fitness_BucketByActivity';
  protected $bucketByActivityTypeDataType = '';
  protected $bucketBySessionType = 'Forminator_Google_Service_Fitness_BucketBySession';
  protected $bucketBySessionDataType = '';
  protected $bucketByTimeType = 'Forminator_Google_Service_Fitness_BucketByTime';
  ...
  public function setBucketByActivitySegment(Forminator_Google_Service_Fitness_BucketByActivity $bucketByActivitySegment)
  {
  ...
  public function setBucketByActivityType(Forminator_Google_Service_Fitness_BucketByActivity $bucketByActivityType)
  {
  ...
  public function setBucketBySession(Forminator_Google_Service_Fitness_BucketBySession $bucketBySession)
  {
  ...
  public function setBucketByTime(Forminator_Google_Service_Fitness_BucketByTime $bucketByTime)
  {
...
class Forminator_Google_Service_Fitness_AggregateResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'bucket';
  protected $internal_gapi_mappings = array(
  );
  protected $bucketType = 'Forminator_Google_Service_Fitness_AggregateBucket';
...
class Forminator_Google_Service_Fitness_Application extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $detailsUrl;
...
class Forminator_Google_Service_Fitness_BucketByActivity extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Fitness_BucketBySession extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $minDurationMillis;
...
class Forminator_Google_Service_Fitness_BucketByTime extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Fitness_DataPoint extends Forminator_Google_Collection
{
  ...
  protected $valueType = 'Forminator_Google_Service_Fitness_Value';
...
class Forminator_Google_Service_Fitness_DataSource extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $applicationType = 'Forminator_Google_Service_Fitness_Application';
  protected $applicationDataType = '';
  public $dataStreamId;
  public $dataStreamName;
  protected $dataTypeType = 'Forminator_Google_Service_Fitness_DataType';
  protected $dataTypeDataType = '';
  protected $deviceType = 'Forminator_Google_Service_Fitness_Device';
  protected $deviceDataType = '';
  public $name;
  public $type;


  public function setApplication(Forminator_Google_Service_Fitness_Application $application)
  {
  ...
  public function setDataType(Forminator_Google_Service_Fitness_DataType $dataType)
  {
  ...
  public function setDevice(Forminator_Google_Service_Fitness_Device $device)
  {
    $this->device = $device;
  }
...
class Forminator_Google_Service_Fitness_DataType extends Forminator_Google_Collection
{
  protected $collection_key = 'field';
  protected $internal_gapi_mappings = array(
  );
  protected $fieldType = 'Forminator_Google_Service_Fitness_DataTypeField';
...
class Forminator_Google_Service_Fitness_DataTypeField extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $format;
...
class Forminator_Google_Service_Fitness_Dataset extends Forminator_Google_Collection
{
  ...
  protected $pointType = 'Forminator_Google_Service_Fitness_DataPoint';
...
class Forminator_Google_Service_Fitness_Device extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $manufacturer;
...
class Forminator_Google_Service_Fitness_ListDataSourcesResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'dataSource';
  protected $internal_gapi_mappings = array(
  );
  protected $dataSourceType = 'Forminator_Google_Service_Fitness_DataSource';
...
class Forminator_Google_Service_Fitness_ListSessionsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'session';
  protected $internal_gapi_mappings = array(
  );
  protected $deletedSessionType = 'Forminator_Google_Service_Fitness_Session';
...
class Forminator_Google_Service_Fitness_MapValue extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fpVal;
...
class Forminator_Google_Service_Fitness_Session extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Fitness_Value extends Forminator_Google_Collection
{
  ...
  public $fpVal;
  public $intVal;
  protected $mapValType = 'Forminator_Google_Service_Fitness_ValueMapValEntry';
...
class Forminator_Google_Service_Fitness_ValueMapValEntry extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
  protected $valueType = 'Forminator_Google_Service_Fitness_MapValue';
  ...
  public function setValue(Forminator_Google_Service_Fitness_MapValue $value)
  {
    $this->value = $value;
  }
  public function getValue()
