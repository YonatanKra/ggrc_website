 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_DataTransfer extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->applications = new Forminator_Google_Service_DataTransfer_Applications_Resource(
        $this,
        $this->serviceName,
        'applications',
        array(
    ...
    $this->transfers = new Forminator_Google_Service_DataTransfer_Transfers_Resource(
        $this,
        $this->serviceName,
        'transfers',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new Forminator_Google_Service_DataTransfer(...);
 *   $applications = $adminService->applications;
 *  </code>
 */
class Forminator_Google_Service_DataTransfer_Applications_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_DataTransfer_Application
   */
  public function get($applicationId, $optParams = array())
  {
    $params = array('applicationId' => $applicationId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_DataTransfer_Application");
  }
   ...
   * @return Forminator_Google_Service_DataTransfer_ApplicationsListResponse
   */
  public function listApplications($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_DataTransfer_ApplicationsListResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_DataTransfer_Transfers_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_DataTransfer_DataTransfer
   */
  public function get($dataTransferId, $optParams = array())
  {
    $params = array('dataTransferId' => $dataTransferId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_DataTransfer_DataTransfer");
  }

  /**
   * Inserts a data transfer request. (transfers.insert)
   *
   * @param Forminator_Google_DataTransfer $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_DataTransfer_DataTransfer
   */
  public function insert(Forminator_Google_Service_DataTransfer_DataTransfer $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_DataTransfer_DataTransfer");
  }
   ...
   * @return Forminator_Google_Service_DataTransfer_DataTransfersListResponse
   */
  public function listTransfers($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_DataTransfer_DataTransfersListResponse");
  }
}
...
class Forminator_Google_Service_DataTransfer_Application extends Forminator_Google_Collection
{
  ...
  public $kind;
  public $name;
  protected $transferParamsType = 'Forminator_Google_Service_DataTransfer_ApplicationTransferParam';
...
class Forminator_Google_Service_DataTransfer_ApplicationDataTransfer extends Forminator_Google_Collection
{
  protected $collection_key = 'applicationTransferParams';
  protected $internal_gapi_mappings = array(
  );
  public $applicationId;
  protected $applicationTransferParamsType = 'Forminator_Google_Service_DataTransfer_ApplicationTransferParam';
...
class Forminator_Google_Service_DataTransfer_ApplicationTransferParam extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_DataTransfer_ApplicationsListResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'applications';
  protected $internal_gapi_mappings = array(
  );
  protected $applicationsType = 'Forminator_Google_Service_DataTransfer_Application';
...
class Forminator_Google_Service_DataTransfer_DataTransfer extends Forminator_Google_Collection
{
  protected $collection_key = 'applicationDataTransfers';
  protected $internal_gapi_mappings = array(
  );
  protected $applicationDataTransfersType = 'Forminator_Google_Service_DataTransfer_ApplicationDataTransfer';
...
class Forminator_Google_Service_DataTransfer_DataTransfersListResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'dataTransfers';
  protected $internal_gapi_mappings = array(
  );
  protected $dataTransfersType = 'Forminator_Google_Service_DataTransfer_DataTransfer';
