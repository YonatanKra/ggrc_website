 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Freebase extends Forminator_Google_Service
{
   ...
   * @return Forminator_Google_Service_Freebase_ReconcileGet
   */
  public function reconcile($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('reconcile', array($params), "Forminator_Google_Service_Freebase_ReconcileGet");
  }
  /**
...
class Forminator_Google_Service_Freebase_ReconcileCandidate extends Forminator_Google_Model
{
  ...
  public $mid;
  public $name;
  protected $notableType = 'Forminator_Google_Service_Freebase_ReconcileCandidateNotable';
  ...
  public function setNotable(Forminator_Google_Service_Freebase_ReconcileCandidateNotable $notable)
  {
...
class Forminator_Google_Service_Freebase_ReconcileCandidateNotable extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Forminator_Google_Service_Freebase_ReconcileGet extends Forminator_Google_Collection
{
  protected $collection_key = 'warning';
  protected $internal_gapi_mappings = array(
  );
  protected $candidateType = 'Forminator_Google_Service_Freebase_ReconcileCandidate';
  protected $candidateDataType = 'array';
  protected $costsType = 'Forminator_Google_Service_Freebase_ReconcileGetCosts';
  protected $costsDataType = '';
  protected $matchType = 'Forminator_Google_Service_Freebase_ReconcileCandidate';
  protected $matchDataType = '';
  protected $warningType = 'Forminator_Google_Service_Freebase_ReconcileGetWarning';
  ...
  public function setCosts(Forminator_Google_Service_Freebase_ReconcileGetCosts $costs)
  {
    $this->costs = $costs;
  }
  ...
  public function setMatch(Forminator_Google_Service_Freebase_ReconcileCandidate $match)
  {
    $this->match = $match;
  }
...
class Forminator_Google_Service_Freebase_ReconcileGetCosts extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $hits;
...
class Forminator_Google_Service_Freebase_ReconcileGetWarning extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $location;
