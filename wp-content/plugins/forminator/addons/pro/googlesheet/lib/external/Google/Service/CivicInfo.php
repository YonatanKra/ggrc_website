 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_CivicInfo extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->divisions = new Forminator_Google_Service_CivicInfo_Divisions_Resource(
        $this,
        $this->serviceName,
        'divisions',
        array(
    ...
    $this->elections = new Forminator_Google_Service_CivicInfo_Elections_Resource(
        $this,
        $this->serviceName,
        'elections',
        array(
    ...
    $this->representatives = new Forminator_Google_Service_CivicInfo_Representatives_Resource(
        $this,
        $this->serviceName,
        'representatives',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $civicinfoService = new Forminator_Google_Service_CivicInfo(...);
 *   $divisions = $civicinfoService->divisions;
 *  </code>
 */
class Forminator_Google_Service_CivicInfo_Divisions_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_CivicInfo_DivisionSearchResponse
   */
  public function search($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Forminator_Google_Service_CivicInfo_DivisionSearchResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_CivicInfo_Elections_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_CivicInfo_ElectionsQueryResponse
   */
  public function electionQuery($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('electionQuery', array($params), "Forminator_Google_Service_CivicInfo_ElectionsQueryResponse");
  }
   ...
   * @return Forminator_Google_Service_CivicInfo_VoterInfoResponse
   */
  public function voterInfoQuery($address, $optParams = array())
  {
    $params = array('address' => $address);
    $params = array_merge($params, $optParams);
    return $this->call('voterInfoQuery', array($params), "Forminator_Google_Service_CivicInfo_VoterInfoResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_CivicInfo_Representatives_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_CivicInfo_RepresentativeInfoResponse
   */
  public function representativeInfoByAddress($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoByAddress', array($params), "Forminator_Google_Service_CivicInfo_RepresentativeInfoResponse");
  }
   ...
   * fulfilling one of these roles will be returned. Divisions that don't contain
   * a matching office will not be returned.
   * @return Forminator_Google_Service_CivicInfo_RepresentativeInfoData
   */
  public function representativeInfoByDivision($ocdId, $optParams = array())
  {
    $params = array('ocdId' => $ocdId);
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoByDivision', array($params), "Forminator_Google_Service_CivicInfo_RepresentativeInfoData");
  }
}
...
class Forminator_Google_Service_CivicInfo_AdministrationRegion extends Forminator_Google_Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
        "localJurisdiction" => "local_jurisdiction",
  );
  protected $electionAdministrationBodyType = 'Forminator_Google_Service_CivicInfo_AdministrativeBody';
  protected $electionAdministrationBodyDataType = '';
  public $id;
  protected $localJurisdictionType = 'Forminator_Google_Service_CivicInfo_AdministrationRegion';
  protected $localJurisdictionDataType = '';
  public $name;
  protected $sourcesType = 'Forminator_Google_Service_CivicInfo_Source';
  protected $sourcesDataType = 'array';


  public function setElectionAdministrationBody(Forminator_Google_Service_CivicInfo_AdministrativeBody $electionAdministrationBody)
  {
  ...
  public function setLocalJurisdiction(Forminator_Google_Service_CivicInfo_AdministrationRegion $localJurisdiction)
  {
...
class Forminator_Google_Service_CivicInfo_AdministrativeBody extends Forminator_Google_Collection
{
  ...
  protected $correspondenceAddressType = 'Forminator_Google_Service_CivicInfo_SimpleAddressType';
  protected $correspondenceAddressDataType = '';
  public $electionInfoUrl;
  protected $electionOfficialsType = 'Forminator_Google_Service_CivicInfo_ElectionOfficial';
  ...
  public $name;
  protected $physicalAddressType = 'Forminator_Google_Service_CivicInfo_SimpleAddressType';
  ...
  public function setCorrespondenceAddress(Forminator_Google_Service_CivicInfo_SimpleAddressType $correspondenceAddress)
  {
  ...
  public function setPhysicalAddress(Forminator_Google_Service_CivicInfo_SimpleAddressType $physicalAddress)
  {
...
class Forminator_Google_Service_CivicInfo_Candidate extends Forminator_Google_Collection
{
  protected $collection_key = 'channels';
  protected $internal_gapi_mappings = array(
  );
  public $candidateUrl;
  protected $channelsType = 'Forminator_Google_Service_CivicInfo_Channel';
...
class Forminator_Google_Service_CivicInfo_Channel extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Forminator_Google_Service_CivicInfo_Contest extends Forminator_Google_Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
  public $ballotPlacement;
  protected $candidatesType = 'Forminator_Google_Service_CivicInfo_Candidate';
  protected $candidatesDataType = 'array';
  protected $districtType = 'Forminator_Google_Service_CivicInfo_ElectoralDistrict';
  ...
  public function setDistrict(Forminator_Google_Service_CivicInfo_ElectoralDistrict $district)
  {
...
class Forminator_Google_Service_CivicInfo_DivisionSearchResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'results';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $resultsType = 'Forminator_Google_Service_CivicInfo_DivisionSearchResult';
...
class Forminator_Google_Service_CivicInfo_DivisionSearchResult extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_CivicInfo_Election extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $electionDay;
...
class Forminator_Google_Service_CivicInfo_ElectionOfficial extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $emailAddress;
...
class Forminator_Google_Service_CivicInfo_ElectionsQueryResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'elections';
  protected $internal_gapi_mappings = array(
  );
  protected $electionsType = 'Forminator_Google_Service_CivicInfo_Election';
...
class Forminator_Google_Service_CivicInfo_ElectoralDistrict extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Forminator_Google_Service_CivicInfo_GeographicDivision extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_CivicInfo_Office extends Forminator_Google_Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_CivicInfo_Official extends Forminator_Google_Collection
{
  protected $collection_key = 'urls';
  protected $internal_gapi_mappings = array(
  );
  protected $addressType = 'Forminator_Google_Service_CivicInfo_SimpleAddressType';
...
class Forminator_Google_Service_CivicInfo_PollingLocation extends Forminator_Google_Collection
{
  protected $collection_key = 'sources';
  protected $internal_gapi_mappings = array(
  );
  ...
  public function setAddress(Forminator_Google_Service_CivicInfo_SimpleAddressType $address)
  {
    $this->address = $address;
  }
  public function getAddress()
...
class Forminator_Google_Service_CivicInfo_RepresentativeInfoData extends Forminator_Google_Collection
{
  protected $collection_key = 'officials';
  protected $internal_gapi_mappings = array(
  );
  protected $divisionsType = 'Forminator_Google_Service_CivicInfo_GeographicDivision';
  protected $divisionsDataType = 'map';
  protected $officesType = 'Forminator_Google_Service_CivicInfo_Office';
  protected $officesDataType = 'array';
  protected $officialsType = 'Forminator_Google_Service_CivicInfo_Official';
...
class Forminator_Google_Service_CivicInfo_RepresentativeInfoResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'officials';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $divisionsDataType = 'map';
  public $kind;
  protected $normalizedInputType = 'Forminator_Google_Service_CivicInfo_SimpleAddressType';
  ...
  public function setNormalizedInput(Forminator_Google_Service_CivicInfo_SimpleAddressType $normalizedInput)
  {
...
class Forminator_Google_Service_CivicInfo_SimpleAddressType extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $city;
...
class Forminator_Google_Service_CivicInfo_Source extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class Forminator_Google_Service_CivicInfo_VoterInfoResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'state';
  protected $internal_gapi_mappings = array(
  );
  protected $contestsType = 'Forminator_Google_Service_CivicInfo_Contest';
  protected $contestsDataType = 'array';
  protected $dropOffLocationsType = 'Forminator_Google_Service_CivicInfo_PollingLocation';
  protected $dropOffLocationsDataType = 'array';
  protected $earlyVoteSitesType = 'Forminator_Google_Service_CivicInfo_PollingLocation';
  protected $earlyVoteSitesDataType = 'array';
  protected $electionType = 'Forminator_Google_Service_CivicInfo_Election';
  protected $electionDataType = '';
  public $kind;
  public $mailOnly;
  protected $normalizedInputType = 'Forminator_Google_Service_CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $otherElectionsType = 'Forminator_Google_Service_CivicInfo_Election';
  protected $otherElectionsDataType = 'array';
  protected $pollingLocationsType = 'Forminator_Google_Service_CivicInfo_PollingLocation';
  protected $pollingLocationsDataType = 'array';
  public $precinctId;
  protected $stateType = 'Forminator_Google_Service_CivicInfo_AdministrationRegion';
  ...
  public function setElection(Forminator_Google_Service_CivicInfo_Election $election)
  {
