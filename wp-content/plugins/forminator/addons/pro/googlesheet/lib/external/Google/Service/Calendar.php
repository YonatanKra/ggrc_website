 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Calendar extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->acl = new Forminator_Google_Service_Calendar_Acl_Resource(
        $this,
        $this->serviceName,
        'acl',
        array(
    ...
    $this->calendarList = new Forminator_Google_Service_Calendar_CalendarList_Resource(
        $this,
        $this->serviceName,
        'calendarList',
        array(
    ...
    $this->calendars = new Forminator_Google_Service_Calendar_Calendars_Resource(
        $this,
        $this->serviceName,
        'calendars',
        array(
    ...
    $this->channels = new Forminator_Google_Service_Calendar_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->colors = new Forminator_Google_Service_Calendar_Colors_Resource(
        $this,
        $this->serviceName,
        'colors',
        array(
    ...
    $this->events = new Forminator_Google_Service_Calendar_Events_Resource(
        $this,
        $this->serviceName,
        'events',
        array(
    ...
    $this->freebusy = new Forminator_Google_Service_Calendar_Freebusy_Resource(
        $this,
        $this->serviceName,
        'freebusy',
        array(
    ...
    $this->settings = new Forminator_Google_Service_Calendar_Settings_Resource(
        $this,
        $this->serviceName,
        'settings',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $calendarService = new Forminator_Google_Service_Calendar(...);
 *   $acl = $calendarService->acl;
 *  </code>
 */
class Forminator_Google_Service_Calendar_Acl_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $ruleId ACL rule identifier.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Calendar_AclRule
   */
  public function get($calendarId, $ruleId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Calendar_AclRule");
  }
   ...
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in user, use the "primary" keyword.
   * @param Forminator_Google_AclRule $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Calendar_AclRule
   */
  public function insert($calendarId, Forminator_Google_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Calendar_AclRule");
  }
   ...
   * @return Forminator_Google_Service_Calendar_Acl
   */
  public function listAcl($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Calendar_Acl");
  }
   ...
   * @return Forminator_Google_Service_Calendar_AclRule
   */
  public function patch($calendarId, $ruleId, Forminator_Google_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Calendar_AclRule");
  }
   ...
   * @return Forminator_Google_Service_Calendar_AclRule
   */
  public function update($calendarId, $ruleId, Forminator_Google_Service_Calendar_AclRule $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Calendar_AclRule");
  }
   ...
   * without any syncToken. Learn more about incremental synchronization.
   * Optional. The default is to return all entries.
   * @return Forminator_Google_Service_Calendar_Channel
   */
  public function watch($calendarId, Forminator_Google_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Forminator_Google_Service_Calendar_Channel");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Calendar_CalendarList_Resource extends Forminator_Google_Service_Resource
{
   ...
   * the currently logged in user, use the "primary" keyword.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Calendar_CalendarListEntry
   */
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Calendar_CalendarListEntry");
  }

  /**
   * Adds an entry to the user's calendar list. (calendarList.insert)
   *
   * @param Forminator_Google_CalendarListEntry $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Forminator_Google_Service_Calendar_CalendarListEntry
   */
  public function insert(Forminator_Google_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return Forminator_Google_Service_Calendar_CalendarList
   */
  public function listCalendarList($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Calendar_CalendarList");
  }
   ...
   * @return Forminator_Google_Service_Calendar_CalendarListEntry
   */
  public function patch($calendarId, Forminator_Google_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return Forminator_Google_Service_Calendar_CalendarListEntry
   */
  public function update($calendarId, Forminator_Google_Service_Calendar_CalendarListEntry $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Calendar_CalendarListEntry");
  }
   ...
   * @return Forminator_Google_Service_Calendar_Channel
   */
  public function watch(Forminator_Google_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Forminator_Google_Service_Calendar_Channel");
 ...
 *  </code>
 */
class Forminator_Google_Service_Calendar_Calendars_Resource extends Forminator_Google_Service_Resource
{
   ...
   * the currently logged in user, use the "primary" keyword.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Calendar_Calendar
   */
  public function get($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Calendar_Calendar");
  }

  /**
   * Creates a secondary calendar. (calendars.insert)
   *
   * @param Forminator_Google_Calendar $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Calendar_Calendar
   */
  public function insert(Forminator_Google_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Calendar_Calendar");
  }
   ...
   * @return Forminator_Google_Service_Calendar_Calendar
   */
  public function patch($calendarId, Forminator_Google_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Calendar_Calendar");
  }
   ...
   * @return Forminator_Google_Service_Calendar_Calendar
   */
  public function update($calendarId, Forminator_Google_Service_Calendar_Calendar $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Calendar_Calendar");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Calendar_Channels_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(Forminator_Google_Service_Calendar_Channel $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
 ...
 *  </code>
 */
class Forminator_Google_Service_Calendar_Colors_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Calendar_Colors
   */
  public function get($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Calendar_Colors");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Calendar_Events_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Calendar_Event
   */
  public function get($calendarId, $eventId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Calendar_Event");
  }
   ...
   * the calendarList.list method. If you want to access the primary calendar of
   * the currently logged in user, use the "primary" keyword.
   * @param Forminator_Google_Event $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Forminator_Google_Service_Calendar_Event
   */
  public function import($calendarId, Forminator_Google_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('import', array($params), "Forminator_Google_Service_Calendar_Event");
  }
   ...
   * @return Forminator_Google_Service_Calendar_Event
   */
  public function insert($calendarId, Forminator_Google_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Calendar_Event");
  }
   ...
   * @opt_param string timeZone Time zone used in the response. Optional. The
   * default is the time zone of the calendar.
   * @return Forminator_Google_Service_Calendar_Events
   */
  public function instances($calendarId, $eventId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId);
    $params = array_merge($params, $optParams);
    return $this->call('instances', array($params), "Forminator_Google_Service_Calendar_Events");
  }
  ...
  public function listEvents($calendarId, $optParams = array())
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Calendar_Events");
  }
  ...
  public function move($calendarId, $eventId, $destination, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "Forminator_Google_Service_Calendar_Event");
  }
   ...
   * @return Forminator_Google_Service_Calendar_Event
   */
  public function patch($calendarId, $eventId, Forminator_Google_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Calendar_Event");
  }
  ...
  public function quickAdd($calendarId, $text, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('quickAdd', array($params), "Forminator_Google_Service_Calendar_Event");
  }
   ...
   * @return Forminator_Google_Service_Calendar_Event
   */
  public function update($calendarId, $eventId, Forminator_Google_Service_Calendar_Event $postBody, $optParams = array())
  {
    $params = array('calendarId' => $calendarId, 'eventId' => $eventId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Calendar_Event");
  }
 ...
 *  </code>
 */
class Forminator_Google_Service_Calendar_Freebusy_Resource extends Forminator_Google_Service_Resource
{

  /**
   * Returns free/busy information for a set of calendars. (freebusy.query)
   *
   * @param Forminator_Google_FreeBusyRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Calendar_FreeBusyResponse
   */
  public function query(Forminator_Google_Service_Calendar_FreeBusyRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Forminator_Google_Service_Calendar_FreeBusyResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Calendar_Settings_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Calendar_Setting
   */
  public function get($setting, $optParams = array())
  {
    $params = array('setting' => $setting);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Calendar_Setting");
  }
   ...
   * synchronization. Optional. The default is to return all entries.
   * @return Forminator_Google_Service_Calendar_Settings
   */
  public function listSettings($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Calendar_Settings");
  }
...
class Forminator_Google_Service_Calendar_Acl extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Forminator_Google_Service_Calendar_AclRule';
...
class Forminator_Google_Service_Calendar_AclRule extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  ...
  public $kind;
  public $role;
  protected $scopeType = 'Forminator_Google_Service_Calendar_AclRuleScope';
  ...
  public function setScope(Forminator_Google_Service_Calendar_AclRuleScope $scope)
  {
    $this->scope = $scope;
  }
...
class Forminator_Google_Service_Calendar_AclRuleScope extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class Forminator_Google_Service_Calendar_Calendar extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class Forminator_Google_Service_Calendar_CalendarList extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Forminator_Google_Service_Calendar_CalendarListEntry';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class Forminator_Google_Service_Calendar_CalendarListEntry extends Forminator_Google_Collection
{
  ...
  public $colorId;
  protected $defaultRemindersType = 'Forminator_Google_Service_Calendar_EventReminder';
  ...
  public $kind;
  public $location;
  protected $notificationSettingsType = 'Forminator_Google_Service_Calendar_CalendarListEntryNotificationSettings';
  ...
  public function setNotificationSettings(Forminator_Google_Service_Calendar_CalendarListEntryNotificationSettings $notificationSettings)
  {
...
class Forminator_Google_Service_Calendar_CalendarListEntryNotificationSettings extends Forminator_Google_Collection
{
  protected $collection_key = 'notifications';
  protected $internal_gapi_mappings = array(
  );
  protected $notificationsType = 'Forminator_Google_Service_Calendar_CalendarNotification';
...
class Forminator_Google_Service_Calendar_CalendarNotification extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $method;
...
class Forminator_Google_Service_Calendar_Channel extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class Forminator_Google_Service_Calendar_ColorDefinition extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $background;
...
class Forminator_Google_Service_Calendar_Colors extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $calendarType = 'Forminator_Google_Service_Calendar_ColorDefinition';
  protected $calendarDataType = 'map';
  protected $eventType = 'Forminator_Google_Service_Calendar_ColorDefinition';
...
class Forminator_Google_Service_Calendar_Error extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $domain;
...
class Forminator_Google_Service_Calendar_Event extends Forminator_Google_Collection
{
  protected $collection_key = 'recurrence';
  protected $internal_gapi_mappings = array(
  );
  public $anyoneCanAddSelf;
  protected $attachmentsType = 'Forminator_Google_Service_Calendar_EventAttachment';
  protected $attachmentsDataType = 'array';
  protected $attendeesType = 'Forminator_Google_Service_Calendar_EventAttendee';
  protected $attendeesDataType = 'array';
  public $attendeesOmitted;
  public $colorId;
  public $created;
  protected $creatorType = 'Forminator_Google_Service_Calendar_EventCreator';
  protected $creatorDataType = '';
  public $description;
  protected $endType = 'Forminator_Google_Service_Calendar_EventDateTime';
  protected $endDataType = '';
  public $endTimeUnspecified;
  public $etag;
  protected $extendedPropertiesType = 'Forminator_Google_Service_Calendar_EventExtendedProperties';
  protected $extendedPropertiesDataType = '';
  protected $gadgetType = 'Forminator_Google_Service_Calendar_EventGadget';
  ...
  public $location;
  public $locked;
  protected $organizerType = 'Forminator_Google_Service_Calendar_EventOrganizer';
  protected $organizerDataType = '';
  protected $originalStartTimeType = 'Forminator_Google_Service_Calendar_EventDateTime';
  protected $originalStartTimeDataType = '';
  public $privateCopy;
  public $recurrence;
  public $recurringEventId;
  protected $remindersType = 'Forminator_Google_Service_Calendar_EventReminders';
  protected $remindersDataType = '';
  public $sequence;
  protected $sourceType = 'Forminator_Google_Service_Calendar_EventSource';
  protected $sourceDataType = '';
  protected $startType = 'Forminator_Google_Service_Calendar_EventDateTime';
  ...
  public function setCreator(Forminator_Google_Service_Calendar_EventCreator $creator)
  {
  ...
  public function setEnd(Forminator_Google_Service_Calendar_EventDateTime $end)
  {
    $this->end = $end;
  }
  ...
  public function setExtendedProperties(Forminator_Google_Service_Calendar_EventExtendedProperties $extendedProperties)
  {
  ...
  public function setGadget(Forminator_Google_Service_Calendar_EventGadget $gadget)
  {
    $this->gadget = $gadget;
  }
  ...
  public function setOrganizer(Forminator_Google_Service_Calendar_EventOrganizer $organizer)
  {
  ...
  public function setOriginalStartTime(Forminator_Google_Service_Calendar_EventDateTime $originalStartTime)
  {
  ...
  public function setReminders(Forminator_Google_Service_Calendar_EventReminders $reminders)
  {
  ...
  public function setSource(Forminator_Google_Service_Calendar_EventSource $source)
  {
    $this->source = $source;
  }
  ...
  public function setStart(Forminator_Google_Service_Calendar_EventDateTime $start)
  {
    $this->start = $start;
  }
...
class Forminator_Google_Service_Calendar_EventAttachment extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $fileId;
...
class Forminator_Google_Service_Calendar_EventAttendee extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Calendar_EventCreator extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class Forminator_Google_Service_Calendar_EventDateTime extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $date;
...
class Forminator_Google_Service_Calendar_EventExtendedProperties extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $private;
...
class Forminator_Google_Service_Calendar_EventGadget extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $display;
...
class Forminator_Google_Service_Calendar_EventOrganizer extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $displayName;
...
class Forminator_Google_Service_Calendar_EventReminder extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $method;
...
class Forminator_Google_Service_Calendar_EventReminders extends Forminator_Google_Collection
{
  protected $collection_key = 'overrides';
  protected $internal_gapi_mappings = array(
  );
  protected $overridesType = 'Forminator_Google_Service_Calendar_EventReminder';
...
class Forminator_Google_Service_Calendar_EventSource extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $title;
...
class Forminator_Google_Service_Calendar_Events extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $description;
  public $etag;
  protected $itemsType = 'Forminator_Google_Service_Calendar_Event';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class Forminator_Google_Service_Calendar_FreeBusyCalendar extends Forminator_Google_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
  protected $busyType = 'Forminator_Google_Service_Calendar_TimePeriod';
  protected $busyDataType = 'array';
  protected $errorsType = 'Forminator_Google_Service_Calendar_Error';
...
class Forminator_Google_Service_Calendar_FreeBusyGroup extends Forminator_Google_Collection
{
  protected $collection_key = 'errors';
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Calendar_FreeBusyRequest extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  ...
  protected $itemsType = 'Forminator_Google_Service_Calendar_FreeBusyRequestItem';
  protected $itemsDataType = 'array';
  public $timeMax;
  public $timeMin;
  public $timeZone;
...
class Forminator_Google_Service_Calendar_FreeBusyRequestItem extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Forminator_Google_Service_Calendar_FreeBusyResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $calendarsType = 'Forminator_Google_Service_Calendar_FreeBusyCalendar';
  protected $calendarsDataType = 'map';
  protected $groupsType = 'Forminator_Google_Service_Calendar_FreeBusyGroup';
...
class Forminator_Google_Service_Calendar_Setting extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class Forminator_Google_Service_Calendar_Settings extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Forminator_Google_Service_Calendar_Setting';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $nextSyncToken;
...
class Forminator_Google_Service_Calendar_TimePeriod extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $end;
