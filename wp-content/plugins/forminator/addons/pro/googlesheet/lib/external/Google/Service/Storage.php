 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Storage extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->bucketAccessControls = new Forminator_Google_Service_Storage_BucketAccessControls_Resource(
        $this,
        $this->serviceName,
    ...
    $this->buckets = new Forminator_Google_Service_Storage_Buckets_Resource(
        $this,
        $this->serviceName,
        'buckets',
        array(
    ...
    $this->channels = new Forminator_Google_Service_Storage_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->defaultObjectAccessControls = new Forminator_Google_Service_Storage_DefaultObjectAccessControls_Resource(
        $this,
        $this->serviceName,
    ...
    $this->objectAccessControls = new Forminator_Google_Service_Storage_ObjectAccessControls_Resource(
        $this,
        $this->serviceName,
    ...
    $this->objects = new Forminator_Google_Service_Storage_Objects_Resource(
        $this,
        $this->serviceName,
        'objects',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $storageService = new Forminator_Google_Service_Storage(...);
 *   $bucketAccessControls = $storageService->bucketAccessControls;
 *  </code>
 */
class Forminator_Google_Service_Storage_BucketAccessControls_Resource extends Forminator_Google_Service_Resource
{
   ...
   * allAuthenticatedUsers.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storage_BucketAccessControl
   */
  public function get($bucket, $entity, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'entity' => $entity);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Storage_BucketAccessControl");
  }
   ...
   *
   * @param string $bucket Name of a bucket.
   * @param Forminator_Google_BucketAccessControl $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storage_BucketAccessControl
   */
  public function insert($bucket, Forminator_Google_Service_Storage_BucketAccessControl $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Storage_BucketAccessControl");
  }
   ...
   * @param string $bucket Name of a bucket.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storage_BucketAccessControls
   */
  public function listBucketAccessControls($bucket, $optParams = array())
  {
    $params = array('bucket' => $bucket);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Storage_BucketAccessControls");
  }
   ...
   * @return Forminator_Google_Service_Storage_BucketAccessControl
   */
  public function patch($bucket, $entity, Forminator_Google_Service_Storage_BucketAccessControl $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'entity' => $entity, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Storage_BucketAccessControl");
  }
   ...
   * @return Forminator_Google_Service_Storage_BucketAccessControl
   */
  public function update($bucket, $entity, Forminator_Google_Service_Storage_BucketAccessControl $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'entity' => $entity, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Storage_BucketAccessControl");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Storage_Buckets_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Storage_Bucket
   */
  public function get($bucket, $optParams = array())
  {
    $params = array('bucket' => $bucket);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Storage_Bucket");
  }
   ...
   * @param Forminator_Google_Bucket $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Forminator_Google_Service_Storage_Bucket
   */
  public function insert($project, Forminator_Google_Service_Storage_Bucket $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Storage_Bucket");
  }
   ...
   * this prefix.
   * @opt_param string projection Set of properties to return. Defaults to noAcl.
   * @return Forminator_Google_Service_Storage_Buckets
   */
  public function listBuckets($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Storage_Buckets");
  }
   ...
   * @return Forminator_Google_Service_Storage_Bucket
   */
  public function patch($bucket, Forminator_Google_Service_Storage_Bucket $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Storage_Bucket");
  }
   ...
   * @return Forminator_Google_Service_Storage_Bucket
   */
  public function update($bucket, Forminator_Google_Service_Storage_Bucket $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Storage_Bucket");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Storage_Channels_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(Forminator_Google_Service_Storage_Channel $postBody, $optParams = array())
  {
 ...
 *  </code>
 */
class Forminator_Google_Service_Storage_DefaultObjectAccessControls_Resource extends Forminator_Google_Service_Resource
{
   ...
   * allAuthenticatedUsers.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storage_ObjectAccessControl
   */
  public function get($bucket, $entity, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'entity' => $entity);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Storage_ObjectAccessControl");
  }
   ...
   *
   * @param string $bucket Name of a bucket.
   * @param Forminator_Google_ObjectAccessControl $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storage_ObjectAccessControl
   */
  public function insert($bucket, Forminator_Google_Service_Storage_ObjectAccessControl $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Storage_ObjectAccessControl");
  }
   ...
   * value.
   * @return Forminator_Google_Service_Storage_ObjectAccessControls
   */
  public function listDefaultObjectAccessControls($bucket, $optParams = array())
  {
    $params = array('bucket' => $bucket);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Storage_ObjectAccessControls");
  }
   ...
   * @return Forminator_Google_Service_Storage_ObjectAccessControl
   */
  public function patch($bucket, $entity, Forminator_Google_Service_Storage_ObjectAccessControl $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'entity' => $entity, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Storage_ObjectAccessControl");
  }
   ...
   * @return Forminator_Google_Service_Storage_ObjectAccessControl
   */
  public function update($bucket, $entity, Forminator_Google_Service_Storage_ObjectAccessControl $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'entity' => $entity, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Storage_ObjectAccessControl");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Storage_ObjectAccessControls_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Storage_ObjectAccessControl
   */
  public function insert($bucket, $object, Forminator_Google_Service_Storage_ObjectAccessControl $postBody, $optParams = array())
  {
   ...
   * @return Forminator_Google_Service_Storage_ObjectAccessControl
   */
  public function patch($bucket, $object, $entity, Forminator_Google_Service_Storage_ObjectAccessControl $postBody, $optParams = array())
  {
   ...
   * @return Forminator_Google_Service_Storage_ObjectAccessControl
   */
  public function update($bucket, $object, $entity, Forminator_Google_Service_Storage_ObjectAccessControl $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'object' => $object, 'entity' => $entity, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Storage_ObjectAccessControl");
 ...
 *  </code>
 */
class Forminator_Google_Service_Storage_Objects_Resource extends Forminator_Google_Service_Resource
{
   ...
   * Parts.
   * @param Forminator_Google_ComposeRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Forminator_Google_Service_Storage_StorageObject
   */
  public function compose($destinationBucket, $destinationObject, Forminator_Google_Service_Storage_ComposeRequest $postBody, $optParams = array())
  {
    $params = array('destinationBucket' => $destinationBucket, 'destinationObject' => $destinationObject, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('compose', array($params), "Forminator_Google_Service_Storage_StorageObject");
  }
   ...
   * name value, if any.
   * @param Forminator_Google_StorageObject $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string destinationPredefinedAcl Apply a predefined set of access
   * controls to the destination object.
   ...
   * @return Forminator_Google_Service_Storage_StorageObject
   */
  public function copy($sourceBucket, $sourceObject, $destinationBucket, $destinationObject, Forminator_Google_Service_Storage_StorageObject $postBody, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('copy', array($params), "Forminator_Google_Service_Storage_StorageObject");
  }
  ...
  public function get($bucket, $object, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'object' => $object);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Storage_StorageObject");
  }
   ...
   * @return Forminator_Google_Service_Storage_StorageObject
   */
  public function insert($bucket, Forminator_Google_Service_Storage_StorageObject $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Storage_StorageObject");
  }
   ...
   * @return Forminator_Google_Service_Storage_Objects
   */
  public function listObjects($bucket, $optParams = array())
  {
    $params = array('bucket' => $bucket);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Storage_Objects");
  }
   ...
   * @return Forminator_Google_Service_Storage_StorageObject
   */
  public function patch($bucket, $object, Forminator_Google_Service_Storage_StorageObject $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Storage_StorageObject");
  }
   ...
   * @opt_param string sourceGeneration If present, selects a specific revision of
   * the source object (as opposed to the latest version, the default).
   * @return Forminator_Google_Service_Storage_RewriteResponse
   */
  public function rewrite($sourceBucket, $sourceObject, $destinationBucket, $destinationObject, Forminator_Google_Service_Storage_StorageObject $postBody, $optParams = array())
  {
    $params = array('sourceBucket' => $sourceBucket, 'sourceObject' => $sourceObject, 'destinationBucket' => $destinationBucket, 'destinationObject' => $destinationObject, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('rewrite', array($params), "Forminator_Google_Service_Storage_RewriteResponse");
  }
   ...
   * @return Forminator_Google_Service_Storage_StorageObject
   */
  public function update($bucket, $object, Forminator_Google_Service_Storage_StorageObject $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Storage_StorageObject");
  }
   ...
   * @opt_param bool versions If true, lists all versions of an object as distinct
   * results. The default is false. For more information, see Object Versioning.
   * @return Forminator_Google_Service_Storage_Channel
   */
  public function watchAll($bucket, Forminator_Google_Service_Storage_Channel $postBody, $optParams = array())
  {
    $params = array('bucket' => $bucket, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watchAll', array($params), "Forminator_Google_Service_Storage_Channel");
  }
}
...
class Forminator_Google_Service_Storage_Bucket extends Forminator_Google_Collection
{
  protected $collection_key = 'defaultObjectAcl';
  protected $internal_gapi_mappings = array(
  );
  protected $aclType = 'Forminator_Google_Service_Storage_BucketAccessControl';
  protected $aclDataType = 'array';
  protected $corsType = 'Forminator_Google_Service_Storage_BucketCors';
  protected $corsDataType = 'array';
  protected $defaultObjectAclType = 'Forminator_Google_Service_Storage_ObjectAccessControl';
  protected $defaultObjectAclDataType = 'array';
  public $etag;
  public $id;
  public $kind;
  protected $lifecycleType = 'Forminator_Google_Service_Storage_BucketLifecycle';
  protected $lifecycleDataType = '';
  public $location;
  protected $loggingType = 'Forminator_Google_Service_Storage_BucketLogging';
  protected $loggingDataType = '';
  public $metageneration;
  public $name;
  protected $ownerType = 'Forminator_Google_Service_Storage_BucketOwner';
  ...
  public $timeCreated;
  public $updated;
  protected $versioningType = 'Forminator_Google_Service_Storage_BucketVersioning';
  protected $versioningDataType = '';
  protected $websiteType = 'Forminator_Google_Service_Storage_BucketWebsite';
  ...
  public function setLifecycle(Forminator_Google_Service_Storage_BucketLifecycle $lifecycle)
  {
  ...
  public function setLogging(Forminator_Google_Service_Storage_BucketLogging $logging)
  {
  ...
  public function setOwner(Forminator_Google_Service_Storage_BucketOwner $owner)
  {
    $this->owner = $owner;
  }
  ...
  public function setVersioning(Forminator_Google_Service_Storage_BucketVersioning $versioning)
  {
  ...
  public function setWebsite(Forminator_Google_Service_Storage_BucketWebsite $website)
  {
...
class Forminator_Google_Service_Storage_BucketAccessControl extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $bucket;
  ...
  public $id;
  public $kind;
  protected $projectTeamType = 'Forminator_Google_Service_Storage_BucketAccessControlProjectTeam';
  ...
  public function setProjectTeam(Forminator_Google_Service_Storage_BucketAccessControlProjectTeam $projectTeam)
  {
...
class Forminator_Google_Service_Storage_BucketAccessControlProjectTeam extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $projectNumber;
...
class Forminator_Google_Service_Storage_BucketAccessControls extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Forminator_Google_Service_Storage_BucketAccessControl';
...
class Forminator_Google_Service_Storage_BucketCors extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Storage_BucketLifecycle extends Forminator_Google_Collection
{
  protected $collection_key = 'rule';
  protected $internal_gapi_mappings = array(
  );
  protected $ruleType = 'Forminator_Google_Service_Storage_BucketLifecycleRule';
...
class Forminator_Google_Service_Storage_BucketLifecycleRule extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $actionType = 'Forminator_Google_Service_Storage_BucketLifecycleRuleAction';
  protected $actionDataType = '';
  protected $conditionType = 'Forminator_Google_Service_Storage_BucketLifecycleRuleCondition';
  protected $conditionDataType = '';


  public function setAction(Forminator_Google_Service_Storage_BucketLifecycleRuleAction $action)
  {
    $this->action = $action;
  }
  ...
  public function setCondition(Forminator_Google_Service_Storage_BucketLifecycleRuleCondition $condition)
  {
...
class Forminator_Google_Service_Storage_BucketLifecycleRuleAction extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class Forminator_Google_Service_Storage_BucketLifecycleRuleCondition extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $age;
...
class Forminator_Google_Service_Storage_BucketLogging extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $logBucket;
...
class Forminator_Google_Service_Storage_BucketOwner extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $entity;
...
class Forminator_Google_Service_Storage_BucketVersioning extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $enabled;
...
class Forminator_Google_Service_Storage_BucketWebsite extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Storage_Buckets extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Forminator_Google_Service_Storage_Bucket';
  protected $itemsDataType = 'array';
  public $kind;
...
class Forminator_Google_Service_Storage_Channel extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class Forminator_Google_Service_Storage_ComposeRequest extends Forminator_Google_Collection
{
  protected $collection_key = 'sourceObjects';
  protected $internal_gapi_mappings = array(
  );
  protected $destinationType = 'Forminator_Google_Service_Storage_StorageObject';
  protected $destinationDataType = '';
  public $kind;
  protected $sourceObjectsType = 'Forminator_Google_Service_Storage_ComposeRequestSourceObjects';
  protected $sourceObjectsDataType = 'array';


  public function setDestination(Forminator_Google_Service_Storage_StorageObject $destination)
  {
...
class Forminator_Google_Service_Storage_ComposeRequestSourceObjects extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $generation;
  public $name;
  protected $objectPreconditionsType = 'Forminator_Google_Service_Storage_ComposeRequestSourceObjectsObjectPreconditions';
  ...
  public function setObjectPreconditions(Forminator_Google_Service_Storage_ComposeRequestSourceObjectsObjectPreconditions $objectPreconditions)
  {
...
class Forminator_Google_Service_Storage_ComposeRequestSourceObjectsObjectPreconditions extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Storage_ObjectAccessControl extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $bucket;
  ...
  public $kind;
  public $object;
  protected $projectTeamType = 'Forminator_Google_Service_Storage_ObjectAccessControlProjectTeam';
  protected $projectTeamDataType = '';
  public $role;
  public $selfLink;
  ...
  public function setProjectTeam(Forminator_Google_Service_Storage_ObjectAccessControlProjectTeam $projectTeam)
  {
    $this->projectTeam = $projectTeam;
  }
  public function getProjectTeam()
...
class Forminator_Google_Service_Storage_ObjectAccessControlProjectTeam extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $projectNumber;
...
class Forminator_Google_Service_Storage_ObjectAccessControls extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Storage_Objects extends Forminator_Google_Collection
{
  protected $collection_key = 'prefixes';
  protected $internal_gapi_mappings = array(
  );
  protected $itemsType = 'Forminator_Google_Service_Storage_StorageObject';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
  public $prefixes;
...
class Forminator_Google_Service_Storage_RewriteResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $done;
  public $kind;
  public $objectSize;
  protected $resourceType = 'Forminator_Google_Service_Storage_StorageObject';
  ...
  public function setResource(Forminator_Google_Service_Storage_StorageObject $resource)
  {
...
class Forminator_Google_Service_Storage_StorageObject extends Forminator_Google_Collection
{
  protected $collection_key = 'acl';
  protected $internal_gapi_mappings = array(
  );
  protected $aclType = 'Forminator_Google_Service_Storage_ObjectAccessControl';
  protected $aclDataType = 'array';
  public $bucket;
  public $cacheControl;
  ...
  public $contentType;
  public $crc32c;
  protected $customerEncryptionType = 'Forminator_Google_Service_Storage_StorageObjectCustomerEncryption';
  ...
  public $metageneration;
  public $name;
  protected $ownerType = 'Forminator_Google_Service_Storage_StorageObjectOwner';
  protected $ownerDataType = '';
  public $selfLink;
  public $size;
  public $storageClass;
  ...
  public function setCustomerEncryption(Forminator_Google_Service_Storage_StorageObjectCustomerEncryption $customerEncryption)
  {
  ...
  public function setOwner(Forminator_Google_Service_Storage_StorageObjectOwner $owner)
  {
    $this->owner = $owner;
  }
  public function getOwner()
...
class Forminator_Google_Service_Storage_StorageObjectCustomerEncryption extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Storage_StorageObjectOwner extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $entity;
