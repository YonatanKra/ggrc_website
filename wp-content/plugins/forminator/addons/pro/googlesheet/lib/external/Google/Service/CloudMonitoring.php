 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_CloudMonitoring extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->metricDescriptors = new Forminator_Google_Service_CloudMonitoring_MetricDescriptors_Resource(
        $this,
        $this->serviceName,
        'metricDescriptors',
        array(
    ...
    $this->timeseries = new Forminator_Google_Service_CloudMonitoring_Timeseries_Resource(
        $this,
        $this->serviceName,
        'timeseries',
        array(
    ...
    $this->timeseriesDescriptors = new Forminator_Google_Service_CloudMonitoring_TimeseriesDescriptors_Resource(
        $this,
        $this->serviceName,
 ...
 * Typical usage is:
 *  <code>
 *   $cloudmonitoringService = new Forminator_Google_Service_CloudMonitoring(...);
 *   $metricDescriptors = $cloudmonitoringService->metricDescriptors;
 *  </code>
 */
class Forminator_Google_Service_CloudMonitoring_MetricDescriptors_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_CloudMonitoring_MetricDescriptor
   */
  public function create($project, Forminator_Google_Service_CloudMonitoring_MetricDescriptor $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_CloudMonitoring_MetricDescriptor");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_CloudMonitoring_DeleteMetricDescriptorResponse
   */
  public function delete($project, $metric, $optParams = array())
  {
    $params = array('project' => $project, 'metric' => $metric);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Forminator_Google_Service_CloudMonitoring_DeleteMetricDescriptorResponse");
  }
   ...
   * @return Forminator_Google_Service_CloudMonitoring_ListMetricDescriptorsResponse
   */
  public function listMetricDescriptors($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_CloudMonitoring_ListMetricDescriptorsResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_CloudMonitoring_Timeseries_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_CloudMonitoring_ListTimeseriesResponse
   */
  public function listTimeseries($project, $metric, $youngest, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_CloudMonitoring_ListTimeseriesResponse");
  }
   ...
   * @param string $project The project ID. The value can be the numeric project
   * ID or string-based project name.
   * @param Forminator_Google_WriteTimeseriesRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_CloudMonitoring_WriteTimeseriesResponse
   */
  public function write($project, Forminator_Google_Service_CloudMonitoring_WriteTimeseriesRequest $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('write', array($params), "Forminator_Google_Service_CloudMonitoring_WriteTimeseriesResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_CloudMonitoring_TimeseriesDescriptors_Resource extends Forminator_Google_Service_Resource
{
   ...
   * d: day  - w: week  Examples: 3m, 4w. Only one unit is allowed, for example:
   * 2w3d is not allowed; you should use 17d instead.
   * @return Forminator_Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse
   */
  public function listTimeseriesDescriptors($project, $metric, $youngest, $optParams = array())
  {
    $params = array('project' => $project, 'metric' => $metric, 'youngest' => $youngest);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse");
  }
}
...
class Forminator_Google_Service_CloudMonitoring_DeleteMetricDescriptorResponse extends Forminator_Google_Model
{
...
class Forminator_Google_Service_CloudMonitoring_ListMetricDescriptorsRequest extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Forminator_Google_Service_CloudMonitoring_ListMetricDescriptorsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'metrics';
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  protected $metricsType = 'Forminator_Google_Service_CloudMonitoring_MetricDescriptor';
...
class Forminator_Google_Service_CloudMonitoring_ListTimeseriesDescriptorsRequest extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Forminator_Google_Service_CloudMonitoring_ListTimeseriesDescriptorsResponse extends Forminator_Google_Collection
{
  ...
  public $nextPageToken;
  public $oldest;
  protected $timeseriesType = 'Forminator_Google_Service_CloudMonitoring_TimeseriesDescriptor';
...
class Forminator_Google_Service_CloudMonitoring_ListTimeseriesRequest extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Forminator_Google_Service_CloudMonitoring_ListTimeseriesResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'timeseries';
  protected $internal_gapi_mappings = array(
  );
  ...
  public $nextPageToken;
  public $oldest;
  protected $timeseriesType = 'Forminator_Google_Service_CloudMonitoring_Timeseries';
  protected $timeseriesDataType = 'array';
  public $youngest;
...
class Forminator_Google_Service_CloudMonitoring_MetricDescriptor extends Forminator_Google_Collection
{
  protected $collection_key = 'labels';
  protected $internal_gapi_mappings = array(
  );
  public $description;
  protected $labelsType = 'Forminator_Google_Service_CloudMonitoring_MetricDescriptorLabelDescriptor';
  protected $labelsDataType = 'array';
  public $name;
  public $project;
  protected $typeDescriptorType = 'Forminator_Google_Service_CloudMonitoring_MetricDescriptorTypeDescriptor';
  ...
  public function setTypeDescriptor(Forminator_Google_Service_CloudMonitoring_MetricDescriptorTypeDescriptor $typeDescriptor)
  {
...
class Forminator_Google_Service_CloudMonitoring_MetricDescriptorLabelDescriptor extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class Forminator_Google_Service_CloudMonitoring_MetricDescriptorTypeDescriptor extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $metricType;
...
class Forminator_Google_Service_CloudMonitoring_Point extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $boolValue;
  protected $distributionValueType = 'Forminator_Google_Service_CloudMonitoring_PointDistribution';
  ...
  public function setDistributionValue(Forminator_Google_Service_CloudMonitoring_PointDistribution $distributionValue)
  {
...
class Forminator_Google_Service_CloudMonitoring_PointDistribution extends Forminator_Google_Collection
{
  protected $collection_key = 'buckets';
  protected $internal_gapi_mappings = array(
  );
  protected $bucketsType = 'Forminator_Google_Service_CloudMonitoring_PointDistributionBucket';
  protected $bucketsDataType = 'array';
  protected $overflowBucketType = 'Forminator_Google_Service_CloudMonitoring_PointDistributionOverflowBucket';
  protected $overflowBucketDataType = '';
  protected $underflowBucketType = 'Forminator_Google_Service_CloudMonitoring_PointDistributionUnderflowBucket';
  ...
  public function setOverflowBucket(Forminator_Google_Service_CloudMonitoring_PointDistributionOverflowBucket $overflowBucket)
  {
  ...
  public function setUnderflowBucket(Forminator_Google_Service_CloudMonitoring_PointDistributionUnderflowBucket $underflowBucket)
  {
...
class Forminator_Google_Service_CloudMonitoring_PointDistributionBucket extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Forminator_Google_Service_CloudMonitoring_PointDistributionOverflowBucket extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Forminator_Google_Service_CloudMonitoring_PointDistributionUnderflowBucket extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Forminator_Google_Service_CloudMonitoring_Timeseries extends Forminator_Google_Collection
{
  protected $collection_key = 'points';
  protected $internal_gapi_mappings = array(
  );
  protected $pointsType = 'Forminator_Google_Service_CloudMonitoring_Point';
  protected $pointsDataType = 'array';
  protected $timeseriesDescType = 'Forminator_Google_Service_CloudMonitoring_TimeseriesDescriptor';
  ...
  public function setTimeseriesDesc(Forminator_Google_Service_CloudMonitoring_TimeseriesDescriptor $timeseriesDesc)
  {
...
class Forminator_Google_Service_CloudMonitoring_TimeseriesDescriptor extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $labels;
...
class Forminator_Google_Service_CloudMonitoring_TimeseriesDescriptorLabel extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
...
class Forminator_Google_Service_CloudMonitoring_TimeseriesPoint extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $pointType = 'Forminator_Google_Service_CloudMonitoring_Point';
  protected $pointDataType = '';
  protected $timeseriesDescType = 'Forminator_Google_Service_CloudMonitoring_TimeseriesDescriptor';
  protected $timeseriesDescDataType = '';


  public function setPoint(Forminator_Google_Service_CloudMonitoring_Point $point)
  {
    $this->point = $point;
  }
...
class Forminator_Google_Service_CloudMonitoring_WriteTimeseriesRequest extends Forminator_Google_Collection
{
  protected $collection_key = 'timeseries';
  protected $internal_gapi_mappings = array(
  );
  public $commonLabels;
  protected $timeseriesType = 'Forminator_Google_Service_CloudMonitoring_TimeseriesPoint';
  protected $timeseriesDataType = 'array';
...
class Forminator_Google_Service_CloudMonitoring_WriteTimeseriesResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
