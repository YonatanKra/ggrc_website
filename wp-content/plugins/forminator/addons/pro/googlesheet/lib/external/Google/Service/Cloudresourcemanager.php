 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Cloudresourcemanager extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->organizations = new Forminator_Google_Service_Cloudresourcemanager_Organizations_Resource(
        $this,
        $this->serviceName,
        'organizations',
        array(
    ...
    $this->projects = new Forminator_Google_Service_Cloudresourcemanager_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $cloudresourcemanagerService = new Forminator_Google_Service_Cloudresourcemanager(...);
 *   $organizations = $cloudresourcemanagerService->organizations;
 *  </code>
 */
class Forminator_Google_Service_Cloudresourcemanager_Organizations_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Cloudresourcemanager_Organization
   */
  public function get($organizationId, $optParams = array())
  {
    $params = array('organizationId' => $organizationId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Cloudresourcemanager_Organization");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Cloudresourcemanager_Policy
   */
  public function getIamPolicy($resource, Forminator_Google_Service_Cloudresourcemanager_GetIamPolicyRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('getIamPolicy', array($params), "Forminator_Google_Service_Cloudresourcemanager_Policy");
  }
   ...
   * This field is optional.
   * @return Forminator_Google_Service_Cloudresourcemanager_ListOrganizationsResponse
   */
  public function listOrganizations($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Cloudresourcemanager_ListOrganizationsResponse");
  }
   ...
   * @return Forminator_Google_Service_Cloudresourcemanager_Policy
   */
  public function setIamPolicy($resource, Forminator_Google_Service_Cloudresourcemanager_SetIamPolicyRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setIamPolicy', array($params), "Forminator_Google_Service_Cloudresourcemanager_Policy");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Cloudresourcemanager_TestIamPermissionsResponse
   */
  public function testIamPermissions($resource, Forminator_Google_Service_Cloudresourcemanager_TestIamPermissionsRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('testIamPermissions', array($params), "Forminator_Google_Service_Cloudresourcemanager_TestIamPermissionsResponse");
  }
   ...
   * @param Forminator_Google_Organization $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Cloudresourcemanager_Organization
   */
  public function update($organizationId, Forminator_Google_Service_Cloudresourcemanager_Organization $postBody, $optParams = array())
  {
    $params = array('organizationId' => $organizationId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Cloudresourcemanager_Organization");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Cloudresourcemanager_Projects_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param Forminator_Google_Project $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Cloudresourcemanager_Project
   */
  public function create(Forminator_Google_Service_Cloudresourcemanager_Project $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Cloudresourcemanager_Project");
  }
   ...
   * Required.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Cloudresourcemanager_Empty
   */
  public function delete($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Forminator_Google_Service_Cloudresourcemanager_Empty");
  }
  ...
  public function get($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Cloudresourcemanager_Project");
  }
   ...
   * @return Forminator_Google_Service_Cloudresourcemanager_ListProjectsResponse
   */
  public function listProjects($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Cloudresourcemanager_ListProjectsResponse");
  }
  ...
  public function undelete($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('undelete', array($params), "Forminator_Google_Service_Cloudresourcemanager_Empty");
  }
   ...
   * @return Forminator_Google_Service_Cloudresourcemanager_Project
   */
  public function update($projectId, Forminator_Google_Service_Cloudresourcemanager_Project $postBody, $optParams = array())
  {
    $params = array('projectId' => $projectId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Cloudresourcemanager_Project");
  }
}
...
class Forminator_Google_Service_Cloudresourcemanager_Binding extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Cloudresourcemanager_Empty extends Forminator_Google_Model
{
}

class Forminator_Google_Service_Cloudresourcemanager_GetIamPolicyRequest extends Forminator_Google_Model
{
}

class Forminator_Google_Service_Cloudresourcemanager_ListOrganizationsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'organizations';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $organizationsType = 'Forminator_Google_Service_Cloudresourcemanager_Organization';
...
class Forminator_Google_Service_Cloudresourcemanager_ListProjectsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'projects';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $projectsType = 'Forminator_Google_Service_Cloudresourcemanager_Project';
...
class Forminator_Google_Service_Cloudresourcemanager_Organization extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $creationTime;
  ...
  protected $ownerType = 'Forminator_Google_Service_Cloudresourcemanager_OrganizationOwner';
  ...
  public function setOwner(Forminator_Google_Service_Cloudresourcemanager_OrganizationOwner $owner)
  {
    $this->owner = $owner;
  }
...
class Forminator_Google_Service_Cloudresourcemanager_OrganizationOwner extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Cloudresourcemanager_Policy extends Forminator_Google_Collection
{
  protected $collection_key = 'bindings';
  protected $internal_gapi_mappings = array(
  );
  protected $bindingsType = 'Forminator_Google_Service_Cloudresourcemanager_Binding';
...
class Forminator_Google_Service_Cloudresourcemanager_Project extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $createTime;
  ...
  public $name;
  protected $parentType = 'Forminator_Google_Service_Cloudresourcemanager_ResourceId';
  ...
  public function setParent(Forminator_Google_Service_Cloudresourcemanager_ResourceId $parent)
  {
    $this->parent = $parent;
  }
...
class Forminator_Google_Service_Cloudresourcemanager_ResourceId extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Forminator_Google_Service_Cloudresourcemanager_SetIamPolicyRequest extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $policyType = 'Forminator_Google_Service_Cloudresourcemanager_Policy';
  protected $policyDataType = '';


  public function setPolicy(Forminator_Google_Service_Cloudresourcemanager_Policy $policy)
  {
    $this->policy = $policy;
  }
...
class Forminator_Google_Service_Cloudresourcemanager_TestIamPermissionsRequest extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Cloudresourcemanager_TestIamPermissionsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'permissions';
  protected $internal_gapi_mappings = array(
  );
