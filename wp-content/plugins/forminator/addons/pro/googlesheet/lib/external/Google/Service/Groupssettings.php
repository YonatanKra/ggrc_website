 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Groupssettings extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->groups = new Forminator_Google_Service_Groupssettings_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $groupssettingsService = new Forminator_Google_Service_Groupssettings(...);
 *   $groups = $groupssettingsService->groups;
 *  </code>
 */
class Forminator_Google_Service_Groupssettings_Groups_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Groupssettings_Groups
   */
  public function get($groupUniqueId, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Groupssettings_Groups");
  }
   ...
   *
   * @param string $groupUniqueId The resource ID
   * @param Forminator_Google_Groups $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Groupssettings_Groups
   */
  public function patch($groupUniqueId, Forminator_Google_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Groupssettings_Groups");
  }
   ...
   * @return Forminator_Google_Service_Groupssettings_Groups
   */
  public function update($groupUniqueId, Forminator_Google_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Groupssettings_Groups");
  }
}
...
class Forminator_Google_Service_Groupssettings_Groups extends Forminator_Google_Model
{
