 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Tasks extends Forminator_Google_Service
{
  /** Manage your tasks. */
  const TASKS =
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->tasklists = new Forminator_Google_Service_Tasks_Tasklists_Resource(
        $this,
        $this->serviceName,
        'tasklists',
        array(
    ...
    $this->tasks = new Forminator_Google_Service_Tasks_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $tasksService = new Forminator_Google_Service_Tasks(...);
 *   $tasklists = $tasksService->tasklists;
 *  </code>
 */
class Forminator_Google_Service_Tasks_Tasklists_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $tasklist Task list identifier.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Tasks_TaskList
   */
  public function get($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Tasks_TaskList");
  }
   ...
   * (tasklists.insert)
   *
   * @param Forminator_Google_TaskList $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Tasks_TaskList
   */
  public function insert(Forminator_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Tasks_TaskList");
  }
   ...
   * Optional.
   * @return Forminator_Google_Service_Tasks_TaskLists
   */
  public function listTasklists($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Tasks_TaskLists");
  }
   ...
   * @return Forminator_Google_Service_Tasks_TaskList
   */
  public function patch($tasklist, Forminator_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Tasks_TaskList");
  }
   ...
   * @return Forminator_Google_Service_Tasks_TaskList
   */
  public function update($tasklist, Forminator_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Tasks_TaskList");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Tasks_Tasks_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $task Task identifier.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Tasks_Task
   */
  public function get($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Tasks_Task");
  }
   ...
   *
   * @param string $tasklist Task list identifier.
   * @param Forminator_Google_Task $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Forminator_Google_Service_Tasks_Task
   */
  public function insert($tasklist, Forminator_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Tasks_Task");
  }
   ...
   * @return Forminator_Google_Service_Tasks_Tasks
   */
  public function listTasks($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Tasks_Tasks");
  }
  ...
  public function move($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "Forminator_Google_Service_Tasks_Task");
  }
   ...
   * @return Forminator_Google_Service_Tasks_Task
   */
  public function patch($tasklist, $task, Forminator_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Tasks_Task");
  }
   ...
   * @return Forminator_Google_Service_Tasks_Task
   */
  public function update($tasklist, $task, Forminator_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Tasks_Task");
  }
}
...
class Forminator_Google_Service_Tasks_Task extends Forminator_Google_Collection
{
  ...
  public $id;
  public $kind;
  protected $linksType = 'Forminator_Google_Service_Tasks_TaskLinks';
...
class Forminator_Google_Service_Tasks_TaskLinks extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $description;
...
class Forminator_Google_Service_Tasks_TaskList extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $etag;
...
class Forminator_Google_Service_Tasks_TaskLists extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Forminator_Google_Service_Tasks_TaskList';
...
class Forminator_Google_Service_Tasks_Tasks extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Forminator_Google_Service_Tasks_Task';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
