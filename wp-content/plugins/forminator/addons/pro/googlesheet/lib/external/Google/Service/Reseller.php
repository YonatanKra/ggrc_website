 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Reseller extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->customers = new Forminator_Google_Service_Reseller_Customers_Resource(
        $this,
        $this->serviceName,
        'customers',
        array(
    ...
    $this->subscriptions = new Forminator_Google_Service_Reseller_Subscriptions_Resource(
        $this,
        $this->serviceName,
        'subscriptions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $resellerService = new Forminator_Google_Service_Reseller(...);
 *   $customers = $resellerService->customers;
 *  </code>
 */
class Forminator_Google_Service_Reseller_Customers_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Reseller_Customer
   */
  public function get($customerId, $optParams = array())
  {
    $params = array('customerId' => $customerId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Reseller_Customer");
  }
   ...
   * @return Forminator_Google_Service_Reseller_Customer
   */
  public function insert(Forminator_Google_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Reseller_Customer");
  }
   ...
   * @return Forminator_Google_Service_Reseller_Customer
   */
  public function patch($customerId, Forminator_Google_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Reseller_Customer");
  }
   ...
   * @return Forminator_Google_Service_Reseller_Customer
   */
  public function update($customerId, Forminator_Google_Service_Reseller_Customer $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_Reseller_Customer");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Reseller_Subscriptions_Resource extends Forminator_Google_Service_Resource
{
   ...
   * customer
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Reseller_Subscription
   */
  public function activate($customerId, $subscriptionId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('activate', array($params), "Forminator_Google_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param Forminator_Google_ChangePlanRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Reseller_Subscription
   */
  public function changePlan($customerId, $subscriptionId, Forminator_Google_Service_Reseller_ChangePlanRequest $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changePlan', array($params), "Forminator_Google_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param Forminator_Google_RenewalSettings $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Reseller_Subscription
   */
  public function changeRenewalSettings($customerId, $subscriptionId, Forminator_Google_Service_Reseller_RenewalSettings $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeRenewalSettings', array($params), "Forminator_Google_Service_Reseller_Subscription");
  }
   ...
   * @param string $subscriptionId Id of the subscription, which is unique for a
   * customer
   * @param Forminator_Google_Seats $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Reseller_Subscription
   */
  public function changeSeats($customerId, $subscriptionId, Forminator_Google_Service_Reseller_Seats $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('changeSeats', array($params), "Forminator_Google_Service_Reseller_Subscription");
  }
  ...
  public function get($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Reseller_Subscription");
  }
   ...
   * @return Forminator_Google_Service_Reseller_Subscription
   */
  public function insert($customerId, Forminator_Google_Service_Reseller_Subscription $postBody, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_Reseller_Subscription");
  }
   ...
   * @return Forminator_Google_Service_Reseller_Subscriptions
   */
  public function listSubscriptions($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Reseller_Subscriptions");
  }
  ...
  public function startPaidService($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('startPaidService', array($params), "Forminator_Google_Service_Reseller_Subscription");
  }
  ...
  public function suspend($customerId, $subscriptionId, $optParams = array())
  {
    $params = array('customerId' => $customerId, 'subscriptionId' => $subscriptionId);
    $params = array_merge($params, $optParams);
    return $this->call('suspend', array($params), "Forminator_Google_Service_Reseller_Subscription");
  }
}
...
class Forminator_Google_Service_Reseller_Address extends Forminator_Google_Model
{
...
class Forminator_Google_Service_Reseller_ChangePlanRequest extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
  ...
  protected $seatsType = 'Forminator_Google_Service_Reseller_Seats';
  ...
  public function setSeats(Forminator_Google_Service_Reseller_Seats $seats)
  {
    $this->seats = $seats;
  }
...
class Forminator_Google_Service_Reseller_Customer extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  ...
  public $kind;
  public $phoneNumber;
  protected $postalAddressType = 'Forminator_Google_Service_Reseller_Address';
  ...
  public function setPostalAddress(Forminator_Google_Service_Reseller_Address $postalAddress)
  {
...
class Forminator_Google_Service_Reseller_RenewalSettings extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Forminator_Google_Service_Reseller_Seats extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $kind;
...
class Forminator_Google_Service_Reseller_Subscription extends Forminator_Google_Collection
{
  ...
  public $customerId;
  public $kind;
  protected $planType = 'Forminator_Google_Service_Reseller_SubscriptionPlan';
  protected $planDataType = '';
  public $purchaseOrderId;
  protected $renewalSettingsType = 'Forminator_Google_Service_Reseller_RenewalSettings';
  ...
  protected $transferInfoType = 'Forminator_Google_Service_Reseller_SubscriptionTransferInfo';
  protected $transferInfoDataType = '';
  protected $trialSettingsType = 'Forminator_Google_Service_Reseller_SubscriptionTrialSettings';
  ...
  public function setPlan(Forminator_Google_Service_Reseller_SubscriptionPlan $plan)
  {
    $this->plan = $plan;
  }
  ...
  public function setRenewalSettings(Forminator_Google_Service_Reseller_RenewalSettings $renewalSettings)
  {
  ...
  public function setTransferInfo(Forminator_Google_Service_Reseller_SubscriptionTransferInfo $transferInfo)
  {
  ...
  public function setTrialSettings(Forminator_Google_Service_Reseller_SubscriptionTrialSettings $trialSettings)
  {
...
class Forminator_Google_Service_Reseller_SubscriptionPlan extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $commitmentIntervalType = 'Forminator_Google_Service_Reseller_SubscriptionPlanCommitmentInterval';
  protected $commitmentIntervalDataType = '';
  public $isCommitmentPlan;
  public $planName;


  public function setCommitmentInterval(Forminator_Google_Service_Reseller_SubscriptionPlanCommitmentInterval $commitmentInterval)
  {
...
class Forminator_Google_Service_Reseller_SubscriptionPlanCommitmentInterval extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $endTime;
...
class Forminator_Google_Service_Reseller_SubscriptionTransferInfo extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Reseller_SubscriptionTrialSettings extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $isInTrial;
...
class Forminator_Google_Service_Reseller_Subscriptions extends Forminator_Google_Collection
{
  ...
  protected $subscriptionsType = 'Forminator_Google_Service_Reseller_Subscription';
