 ...
 *
 */
class Forminator_Google_Service_Resource
{
  ...
  /** @var Forminator_Google_Client $client */
  private $client;
   ...
   * @return Forminator_Google_Http_Request|expected_class
  ...
  public function call($name, $arguments, $expected_class = null)
  {
    ...
    if (isset($parameters['postBody'])) {
      ...
      if ($postBody === false && $parameters['postBody'] !== false) {
        throw new Forminator_Google_Exception("JSON encoding failed. Ensure all strings in the request are UTF-8 encoded.");
      }
    ...
    foreach ($parameters as $key => $val) {
      if ($key != 'postBody' && ! isset($method['parameters'][$key])) {
        ...
        throw new Forminator_Google_Exception("($name) unknown parameter: '$key'");
      }
    }
    ...
    foreach ($method['parameters'] as $paramName => $paramSpec) {
      if (isset($paramSpec['required']) &&
        ...
        throw new Forminator_Google_Exception("($name) missing required param: '$paramName'");
      }
    ...
    $url = Forminator_Google_Http_REST::createRequestUri(
        $this->servicePath,
        $method['path'],
        $parameters
    );
    ...
    if (isset($parameters['data']) &&
      ...
      $mfu = new Forminator_Google_Http_MediaFileUpload(
          $this->client,
          $httpRequest,
