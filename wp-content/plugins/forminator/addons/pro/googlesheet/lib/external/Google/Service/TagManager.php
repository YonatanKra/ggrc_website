 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_TagManager extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->accounts = new Forminator_Google_Service_TagManager_Accounts_Resource(
        $this,
        $this->serviceName,
        'accounts',
        array(
    ...
    $this->accounts_containers = new Forminator_Google_Service_TagManager_AccountsContainers_Resource(
        $this,
        $this->serviceName,
        'containers',
        array(
    ...
    $this->accounts_containers_folders = new Forminator_Google_Service_TagManager_AccountsContainersFolders_Resource(
        $this,
        $this->serviceName,
        'folders',
        array(
    ...
    $this->accounts_containers_folders_entities = new Forminator_Google_Service_TagManager_AccountsContainersFoldersEntities_Resource(
        $this,
        $this->serviceName,
        'entities',
        array(
    ...
    $this->accounts_containers_move_folders = new Forminator_Google_Service_TagManager_AccountsContainersMoveFolders_Resource(
        $this,
        $this->serviceName,
        'move_folders',
        array(
    ...
    $this->accounts_containers_tags = new Forminator_Google_Service_TagManager_AccountsContainersTags_Resource(
        $this,
        $this->serviceName,
        'tags',
        array(
    ...
    $this->accounts_containers_triggers = new Forminator_Google_Service_TagManager_AccountsContainersTriggers_Resource(
        $this,
        $this->serviceName,
        'triggers',
        array(
    ...
    $this->accounts_containers_variables = new Forminator_Google_Service_TagManager_AccountsContainersVariables_Resource(
        $this,
        $this->serviceName,
        'variables',
        array(
    ...
    $this->accounts_containers_versions = new Forminator_Google_Service_TagManager_AccountsContainersVersions_Resource(
        $this,
        $this->serviceName,
        'versions',
        array(
    ...
    $this->accounts_permissions = new Forminator_Google_Service_TagManager_AccountsPermissions_Resource(
        $this,
        $this->serviceName,
        'permissions',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $tagmanagerService = new Forminator_Google_Service_TagManager(...);
 *   $accounts = $tagmanagerService->accounts;
 *  </code>
 */
class Forminator_Google_Service_TagManager_Accounts_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_TagManager_Account
   */
  public function get($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_TagManager_Account");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_ListAccountsResponse
   */
  public function listAccounts($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_ListAccountsResponse");
  }
   ...
   * @return Forminator_Google_Service_TagManager_Account
   */
  public function update($accountId, Forminator_Google_Service_TagManager_Account $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_TagManager_Account");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsContainers_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param string $accountId The GTM Account ID.
   * @param Forminator_Google_Container $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_Container
   */
  public function create($accountId, Forminator_Google_Service_TagManager_Container $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_TagManager_Container");
  }
  ...
  public function get($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_TagManager_Container");
  }
   ...
   * @param string $accountId The GTM Account ID.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_ListContainersResponse
   */
  public function listAccountsContainers($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_ListContainersResponse");
  }
   ...
   * @return Forminator_Google_Service_TagManager_Container
   */
  public function update($accountId, $containerId, Forminator_Google_Service_TagManager_Container $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_TagManager_Container");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsContainersFolders_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $accountId The GTM Account ID.
   * @param string $containerId The GTM Container ID.
   * @param Forminator_Google_Folder $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_Folder
   */
  public function create($accountId, $containerId, Forminator_Google_Service_TagManager_Folder $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_TagManager_Folder");
  }
  ...
  public function get($accountId, $containerId, $folderId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'folderId' => $folderId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_TagManager_Folder");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_ListFoldersResponse
   */
  public function listAccountsContainersFolders($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_ListFoldersResponse");
  }
   ...
   * @return Forminator_Google_Service_TagManager_Folder
   */
  public function update($accountId, $containerId, $folderId, Forminator_Google_Service_TagManager_Folder $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'folderId' => $folderId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_TagManager_Folder");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsContainersFoldersEntities_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $folderId The GTM Folder ID.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_FolderEntities
   */
  public function listAccountsContainersFoldersEntities($accountId, $containerId, $folderId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'folderId' => $folderId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_FolderEntities");
  }
}
/**
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsContainersMoveFolders_Resource extends Forminator_Google_Service_Resource
{
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsContainersTags_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $accountId The GTM Account ID.
   * @param string $containerId The GTM Container ID.
   * @param Forminator_Google_Tag $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_Tag
   */
  public function create($accountId, $containerId, Forminator_Google_Service_TagManager_Tag $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_TagManager_Tag");
  }
  ...
  public function get($accountId, $containerId, $tagId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'tagId' => $tagId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_TagManager_Tag");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_ListTagsResponse
   */
  public function listAccountsContainersTags($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_ListTagsResponse");
  }
   ...
   * @return Forminator_Google_Service_TagManager_Tag
   */
  public function update($accountId, $containerId, $tagId, Forminator_Google_Service_TagManager_Tag $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'tagId' => $tagId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_TagManager_Tag");
  }
}
/**
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsContainersTriggers_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $accountId The GTM Account ID.
   * @param string $containerId The GTM Container ID.
   * @param Forminator_Google_Trigger $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_Trigger
   */
  public function create($accountId, $containerId, Forminator_Google_Service_TagManager_Trigger $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_TagManager_Trigger");
  }
  ...
  public function get($accountId, $containerId, $triggerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'triggerId' => $triggerId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_TagManager_Trigger");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_ListTriggersResponse
   */
  public function listAccountsContainersTriggers($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_ListTriggersResponse");
  }
   ...
   * @return Forminator_Google_Service_TagManager_Trigger
   */
  public function update($accountId, $containerId, $triggerId, Forminator_Google_Service_TagManager_Trigger $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'triggerId' => $triggerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_TagManager_Trigger");
  }
}
/**
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsContainersVariables_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $accountId The GTM Account ID.
   * @param string $containerId The GTM Container ID.
   * @param Forminator_Google_Variable $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_Variable
   */
  public function create($accountId, $containerId, Forminator_Google_Service_TagManager_Variable $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_TagManager_Variable");
  }
  ...
  public function get($accountId, $containerId, $variableId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'variableId' => $variableId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_TagManager_Variable");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_ListVariablesResponse
   */
  public function listAccountsContainersVariables($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_ListVariablesResponse");
  }
   ...
   * @return Forminator_Google_Service_TagManager_Variable
   */
  public function update($accountId, $containerId, $variableId, Forminator_Google_Service_TagManager_Variable $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'variableId' => $variableId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_TagManager_Variable");
  }
}
/**
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsContainersVersions_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param string $accountId The GTM Account ID.
   * @param string $containerId The GTM Container ID.
   * @param Forminator_Google_CreateContainerVersionRequestVersionOptions $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_CreateContainerVersionResponse
   */
  public function create($accountId, $containerId, Forminator_Google_Service_TagManager_CreateContainerVersionRequestVersionOptions $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_TagManager_CreateContainerVersionResponse");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_ContainerVersion
   */
  public function get($accountId, $containerId, $containerVersionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_TagManager_ContainerVersion");
  }
   ...
   * true.
   * @return Forminator_Google_Service_TagManager_ListContainerVersionsResponse
   */
  public function listAccountsContainersVersions($accountId, $containerId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_ListContainerVersionsResponse");
  }
   ...
   * @return Forminator_Google_Service_TagManager_PublishContainerVersionResponse
   */
  public function publish($accountId, $containerId, $containerVersionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
    $params = array_merge($params, $optParams);
    return $this->call('publish', array($params), "Forminator_Google_Service_TagManager_PublishContainerVersionResponse");
  }
  ...
  public function restore($accountId, $containerId, $containerVersionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
    $params = array_merge($params, $optParams);
    return $this->call('restore', array($params), "Forminator_Google_Service_TagManager_ContainerVersion");
  }
  ...
  public function undelete($accountId, $containerId, $containerVersionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId);
    $params = array_merge($params, $optParams);
    return $this->call('undelete', array($params), "Forminator_Google_Service_TagManager_ContainerVersion");
  }
   ...
   * @param string $containerId The GTM Container ID.
   * @param string $containerVersionId The GTM Container Version ID.
   * @param Forminator_Google_ContainerVersion $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param string fingerprint When provided, this fingerprint must match the
   * fingerprint of the container version in storage.
   * @return Forminator_Google_Service_TagManager_ContainerVersion
   */
  public function update($accountId, $containerId, $containerVersionId, Forminator_Google_Service_TagManager_ContainerVersion $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'containerId' => $containerId, 'containerVersionId' => $containerVersionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_TagManager_ContainerVersion");
  }
}
/**
 ...
 *  </code>
 */
class Forminator_Google_Service_TagManager_AccountsPermissions_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param string $accountId The GTM Account ID.
   * @param Forminator_Google_UserAccess $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_UserAccess
   */
  public function create($accountId, Forminator_Google_Service_TagManager_UserAccess $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_TagManager_UserAccess");
  }
  ...
  public function get($accountId, $permissionId, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'permissionId' => $permissionId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_TagManager_UserAccess");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_TagManager_ListAccountUsersResponse
   */
  public function listAccountsPermissions($accountId, $optParams = array())
  {
    $params = array('accountId' => $accountId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_TagManager_ListAccountUsersResponse");
  }
   ...
   * @return Forminator_Google_Service_TagManager_UserAccess
   */
  public function update($accountId, $permissionId, Forminator_Google_Service_TagManager_UserAccess $postBody, $optParams = array())
  {
    $params = array('accountId' => $accountId, 'permissionId' => $permissionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Forminator_Google_Service_TagManager_UserAccess");
  }
}
...
class Forminator_Google_Service_TagManager_Account extends Forminator_Google_Model
{
...
class Forminator_Google_Service_TagManager_AccountAccess extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_TagManager_Condition extends Forminator_Google_Collection
{
  protected $collection_key = 'parameter';
  protected $internal_gapi_mappings = array(
  );
  protected $parameterType = 'Forminator_Google_Service_TagManager_Parameter';
...
class Forminator_Google_Service_TagManager_Container extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_TagManager_ContainerAccess extends Forminator_Google_Collection
{
  protected $collection_key = 'permission';
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_TagManager_ContainerVersion extends Forminator_Google_Collection
{
  protected $collection_key = 'variable';
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
  protected $containerType = 'Forminator_Google_Service_TagManager_Container';
  protected $containerDataType = '';
  public $containerId;
  public $containerVersionId;
  public $deleted;
  public $fingerprint;
  protected $folderType = 'Forminator_Google_Service_TagManager_Folder';
  protected $folderDataType = 'array';
  protected $macroType = 'Forminator_Google_Service_TagManager_Macro';
  protected $macroDataType = 'array';
  public $name;
  public $notes;
  protected $ruleType = 'Forminator_Google_Service_TagManager_Rule';
  protected $ruleDataType = 'array';
  protected $tagType = 'Forminator_Google_Service_TagManager_Tag';
  protected $tagDataType = 'array';
  protected $triggerType = 'Forminator_Google_Service_TagManager_Trigger';
  protected $triggerDataType = 'array';
  protected $variableType = 'Forminator_Google_Service_TagManager_Variable';
  ...
  public function setContainer(Forminator_Google_Service_TagManager_Container $container)
  {
...
class Forminator_Google_Service_TagManager_ContainerVersionHeader extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
...
class Forminator_Google_Service_TagManager_CreateContainerVersionRequestVersionOptions extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $name;
...
class Forminator_Google_Service_TagManager_CreateContainerVersionResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $compilerError;
  protected $containerVersionType = 'Forminator_Google_Service_TagManager_ContainerVersion';
  ...
  public function setContainerVersion(Forminator_Google_Service_TagManager_ContainerVersion $containerVersion)
  {
...
class Forminator_Google_Service_TagManager_Folder extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
...
class Forminator_Google_Service_TagManager_FolderEntities extends Forminator_Google_Collection
{
  protected $collection_key = 'variable';
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_TagManager_ListAccountUsersResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'userAccess';
  protected $internal_gapi_mappings = array(
  );
  protected $userAccessType = 'Forminator_Google_Service_TagManager_UserAccess';
...
class Forminator_Google_Service_TagManager_ListAccountsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'accounts';
  protected $internal_gapi_mappings = array(
  );
  protected $accountsType = 'Forminator_Google_Service_TagManager_Account';
...
class Forminator_Google_Service_TagManager_ListContainerVersionsResponse extends Forminator_Google_Collection
{
  ...
  protected $containerVersionHeaderType = 'Forminator_Google_Service_TagManager_ContainerVersionHeader';
...
class Forminator_Google_Service_TagManager_ListContainersResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'containers';
  protected $internal_gapi_mappings = array(
  );
  protected $containersType = 'Forminator_Google_Service_TagManager_Container';
...
class Forminator_Google_Service_TagManager_ListFoldersResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'folders';
  protected $internal_gapi_mappings = array(
  );
  protected $foldersType = 'Forminator_Google_Service_TagManager_Folder';
...
class Forminator_Google_Service_TagManager_ListTagsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'tags';
  protected $internal_gapi_mappings = array(
  );
  protected $tagsType = 'Forminator_Google_Service_TagManager_Tag';
...
class Forminator_Google_Service_TagManager_ListTriggersResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'triggers';
  protected $internal_gapi_mappings = array(
  );
  protected $triggersType = 'Forminator_Google_Service_TagManager_Trigger';
...
class Forminator_Google_Service_TagManager_ListVariablesResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'variables';
  protected $internal_gapi_mappings = array(
  );
  protected $variablesType = 'Forminator_Google_Service_TagManager_Variable';
...
class Forminator_Google_Service_TagManager_Macro extends Forminator_Google_Collection
{
  protected $collection_key = 'parameter';
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_TagManager_Parameter extends Forminator_Google_Collection
{
  protected $collection_key = 'map';
  protected $internal_gapi_mappings = array(
  );
  public $key;
  protected $listType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $listDataType = 'array';
  protected $mapType = 'Forminator_Google_Service_TagManager_Parameter';
...
class Forminator_Google_Service_TagManager_PublishContainerVersionResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $compilerError;
...
class Forminator_Google_Service_TagManager_Rule extends Forminator_Google_Collection
{
  protected $collection_key = 'condition';
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
  protected $conditionType = 'Forminator_Google_Service_TagManager_Condition';
...
class Forminator_Google_Service_TagManager_SetupTag extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_TagManager_Tag extends Forminator_Google_Collection
{
  ...
  protected $parameterDataType = 'array';
  public $parentFolderId;
  protected $priorityType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $priorityDataType = '';
  public $scheduleEndMs;
  public $scheduleStartMs;
  protected $setupTagType = 'Forminator_Google_Service_TagManager_SetupTag';
  protected $setupTagDataType = 'array';
  public $tagFiringOption;
  public $tagId;
  protected $teardownTagType = 'Forminator_Google_Service_TagManager_TeardownTag';
  ...
  public function setPriority(Forminator_Google_Service_TagManager_Parameter $priority)
  {
...
class Forminator_Google_Service_TagManager_TeardownTag extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_TagManager_Trigger extends Forminator_Google_Collection
{
  protected $collection_key = 'filter';
  protected $internal_gapi_mappings = array(
  );
  public $accountId;
  protected $autoEventFilterType = 'Forminator_Google_Service_TagManager_Condition';
  protected $autoEventFilterDataType = 'array';
  protected $checkValidationType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $checkValidationDataType = '';
  public $containerId;
  protected $customEventFilterType = 'Forminator_Google_Service_TagManager_Condition';
  protected $customEventFilterDataType = 'array';
  protected $enableAllVideosType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $enableAllVideosDataType = '';
  protected $eventNameType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $eventNameDataType = '';
  protected $filterType = 'Forminator_Google_Service_TagManager_Condition';
  protected $filterDataType = 'array';
  public $fingerprint;
  protected $intervalType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $intervalDataType = '';
  protected $limitType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $limitDataType = '';
  public $name;
  public $parentFolderId;
  public $triggerId;
  public $type;
  protected $uniqueTriggerIdType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $uniqueTriggerIdDataType = '';
  protected $videoPercentageListType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $videoPercentageListDataType = '';
  protected $waitForTagsType = 'Forminator_Google_Service_TagManager_Parameter';
  protected $waitForTagsDataType = '';
  protected $waitForTagsTimeoutType = 'Forminator_Google_Service_TagManager_Parameter';
  ...
  public function setCheckValidation(Forminator_Google_Service_TagManager_Parameter $checkValidation)
  {
  ...
  public function setEnableAllVideos(Forminator_Google_Service_TagManager_Parameter $enableAllVideos)
  {
  ...
  public function setEventName(Forminator_Google_Service_TagManager_Parameter $eventName)
  {
  ...
  public function setInterval(Forminator_Google_Service_TagManager_Parameter $interval)
  {
  ...
  public function setLimit(Forminator_Google_Service_TagManager_Parameter $limit)
  {
    $this->limit = $limit;
  }
  ...
  public function setUniqueTriggerId(Forminator_Google_Service_TagManager_Parameter $uniqueTriggerId)
  {
  ...
  public function setVideoPercentageList(Forminator_Google_Service_TagManager_Parameter $videoPercentageList)
  {
  ...
  public function setWaitForTags(Forminator_Google_Service_TagManager_Parameter $waitForTags)
  {
  ...
  public function setWaitForTagsTimeout(Forminator_Google_Service_TagManager_Parameter $waitForTagsTimeout)
  {
...
class Forminator_Google_Service_TagManager_UserAccess extends Forminator_Google_Collection
{
  protected $collection_key = 'containerAccess';
  protected $internal_gapi_mappings = array(
  );
  protected $accountAccessType = 'Forminator_Google_Service_TagManager_AccountAccess';
  protected $accountAccessDataType = '';
  public $accountId;
  protected $containerAccessType = 'Forminator_Google_Service_TagManager_ContainerAccess';
  protected $containerAccessDataType = 'array';
  public $emailAddress;
  public $permissionId;


  public function setAccountAccess(Forminator_Google_Service_TagManager_AccountAccess $accountAccess)
  {
...
class Forminator_Google_Service_TagManager_Variable extends Forminator_Google_Collection
{
  protected $collection_key = 'parameter';
  protected $internal_gapi_mappings = array(
  );
