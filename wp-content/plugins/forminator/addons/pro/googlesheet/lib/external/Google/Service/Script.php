 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Script extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->scripts = new Forminator_Google_Service_Script_Scripts_Resource(
        $this,
        $this->serviceName,
        'scripts',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $scriptService = new Forminator_Google_Service_Script(...);
 *   $scripts = $scriptService->scripts;
 *  </code>
 */
class Forminator_Google_Service_Script_Scripts_Resource extends Forminator_Google_Service_Resource
{
   ...
   * Project properties**.
   * @param Forminator_Google_ExecutionRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Script_Operation
   */
  public function run($scriptId, Forminator_Google_Service_Script_ExecutionRequest $postBody, $optParams = array())
  {
    $params = array('scriptId' => $scriptId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('run', array($params), "Forminator_Google_Service_Script_Operation");
  }
}
...
class Forminator_Google_Service_Script_ExecutionError extends Forminator_Google_Collection
{
  ...
  public $errorMessage;
  public $errorType;
  protected $scriptStackTraceElementsType = 'Forminator_Google_Service_Script_ScriptStackTraceElement';
...
class Forminator_Google_Service_Script_ExecutionRequest extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Script_ExecutionResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $result;
...
class Forminator_Google_Service_Script_Operation extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $done;
  protected $errorType = 'Forminator_Google_Service_Script_Status';
  ...
  public function setError(Forminator_Google_Service_Script_Status $error)
  {
    $this->error = $error;
  }
...
class Forminator_Google_Service_Script_ScriptStackTraceElement extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $function;
...
class Forminator_Google_Service_Script_Status extends Forminator_Google_Collection
{
