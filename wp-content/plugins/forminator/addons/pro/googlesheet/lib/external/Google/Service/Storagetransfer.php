 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Storagetransfer extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->googleServiceAccounts = new Forminator_Google_Service_Storagetransfer_GoogleServiceAccounts_Resource(
        $this,
        $this->serviceName,
    ...
    $this->transferJobs = new Forminator_Google_Service_Storagetransfer_TransferJobs_Resource(
        $this,
        $this->serviceName,
        'transferJobs',
        array(
    ...
    $this->transferOperations = new Forminator_Google_Service_Storagetransfer_TransferOperations_Resource(
        $this,
        $this->serviceName,
        'transferOperations',
        array(
    ...
    $this->v1 = new Forminator_Google_Service_Storagetransfer_V1_Resource(
        $this,
        $this->serviceName,
        'v1',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $storagetransferService = new Forminator_Google_Service_Storagetransfer(...);
 *   $googleServiceAccounts = $storagetransferService->googleServiceAccounts;
 *  </code>
 */
class Forminator_Google_Service_Storagetransfer_GoogleServiceAccounts_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Storagetransfer_GoogleServiceAccount
   */
  public function get($projectId, $optParams = array())
  {
    $params = array('projectId' => $projectId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Storagetransfer_GoogleServiceAccount");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Storagetransfer_TransferJobs_Resource extends Forminator_Google_Service_Resource
{

  /**
   * Creates a transfer job that runs periodically. (transferJobs.create)
   *
   * @param Forminator_Google_TransferJob $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storagetransfer_TransferJob
   */
  public function create(Forminator_Google_Service_Storagetransfer_TransferJob $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Storagetransfer_TransferJob");
  }
  ...
  public function get($jobName, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Storagetransfer_TransferJob");
  }
   ...
   * @return Forminator_Google_Service_Storagetransfer_ListTransferJobsResponse
   */
  public function listTransferJobs($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Storagetransfer_ListTransferJobsResponse");
  }
   ...
   * @param Forminator_Google_UpdateTransferJobRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storagetransfer_TransferJob
   */
  public function patch($jobName, Forminator_Google_Service_Storagetransfer_UpdateTransferJobRequest $postBody, $optParams = array())
  {
    $params = array('jobName' => $jobName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Forminator_Google_Service_Storagetransfer_TransferJob");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Storagetransfer_TransferOperations_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storagetransfer_Empty
   */
  public function cancel($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Forminator_Google_Service_Storagetransfer_Empty");
  }
  ...
  public function delete($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Forminator_Google_Service_Storagetransfer_Empty");
  }
   ...
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storagetransfer_Operation
   */
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Storagetransfer_Operation");
  }
   ...
   * @return Forminator_Google_Service_Storagetransfer_ListOperationsResponse
   */
  public function listTransferOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Storagetransfer_ListOperationsResponse");
  }
   ...
   * @param Forminator_Google_PauseTransferOperationRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storagetransfer_Empty
   */
  public function pause($name, Forminator_Google_Service_Storagetransfer_PauseTransferOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('pause', array($params), "Forminator_Google_Service_Storagetransfer_Empty");
  }
   ...
   *
   * @param string $name The name of the transfer operation. Required.
   * @param Forminator_Google_ResumeTransferOperationRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Storagetransfer_Empty
   */
  public function resume($name, Forminator_Google_Service_Storagetransfer_ResumeTransferOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('resume', array($params), "Forminator_Google_Service_Storagetransfer_Empty");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Storagetransfer_V1_Resource extends Forminator_Google_Service_Resource
{
  ...
  public function getGoogleServiceAccount($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('getGoogleServiceAccount', array($params), "Forminator_Google_Service_Storagetransfer_GoogleServiceAccount");
  }
}
...
class Forminator_Google_Service_Storagetransfer_AwsAccessKey extends Forminator_Google_Model
{
...
class Forminator_Google_Service_Storagetransfer_AwsS3Data extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $awsAccessKeyType = 'Forminator_Google_Service_Storagetransfer_AwsAccessKey';
  protected $awsAccessKeyDataType = '';
  public $bucketName;


  public function setAwsAccessKey(Forminator_Google_Service_Storagetransfer_AwsAccessKey $awsAccessKey)
  {
...
class Forminator_Google_Service_Storagetransfer_Date extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $day;
...
class Forminator_Google_Service_Storagetransfer_Empty extends Forminator_Google_Model
{
}

class Forminator_Google_Service_Storagetransfer_ErrorLogEntry extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Storagetransfer_ErrorSummary extends Forminator_Google_Collection
{
  ...
  public $errorCode;
  public $errorCount;
  protected $errorLogEntriesType = 'Forminator_Google_Service_Storagetransfer_ErrorLogEntry';
...
class Forminator_Google_Service_Storagetransfer_GcsData extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $bucketName;
...
class Forminator_Google_Service_Storagetransfer_GoogleServiceAccount extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $accountEmail;
...
class Forminator_Google_Service_Storagetransfer_HttpData extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $listUrl;
...
class Forminator_Google_Service_Storagetransfer_ListOperationsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'operations';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $operationsType = 'Forminator_Google_Service_Storagetransfer_Operation';
...
class Forminator_Google_Service_Storagetransfer_ListTransferJobsResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'transferJobs';
  protected $internal_gapi_mappings = array(
  );
  public $nextPageToken;
  protected $transferJobsType = 'Forminator_Google_Service_Storagetransfer_TransferJob';
...
class Forminator_Google_Service_Storagetransfer_ObjectConditions extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Storagetransfer_Operation extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $done;
  protected $errorType = 'Forminator_Google_Service_Storagetransfer_Status';
  ...
  public function setError(Forminator_Google_Service_Storagetransfer_Status $error)
  {
    $this->error = $error;
  }
...
class Forminator_Google_Service_Storagetransfer_PauseTransferOperationRequest extends Forminator_Google_Model
{
}

class Forminator_Google_Service_Storagetransfer_ResumeTransferOperationRequest extends Forminator_Google_Model
{
}

class Forminator_Google_Service_Storagetransfer_Schedule extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $scheduleEndDateType = 'Forminator_Google_Service_Storagetransfer_Date';
  protected $scheduleEndDateDataType = '';
  protected $scheduleStartDateType = 'Forminator_Google_Service_Storagetransfer_Date';
  protected $scheduleStartDateDataType = '';
  protected $startTimeOfDayType = 'Forminator_Google_Service_Storagetransfer_TimeOfDay';
  protected $startTimeOfDayDataType = '';


  public function setScheduleEndDate(Forminator_Google_Service_Storagetransfer_Date $scheduleEndDate)
  {
  ...
  public function setScheduleStartDate(Forminator_Google_Service_Storagetransfer_Date $scheduleStartDate)
  {
  ...
  public function setStartTimeOfDay(Forminator_Google_Service_Storagetransfer_TimeOfDay $startTimeOfDay)
  {
...
class Forminator_Google_Service_Storagetransfer_Status extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Storagetransfer_TimeOfDay extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $hours;
...
class Forminator_Google_Service_Storagetransfer_TransferCounters extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Storagetransfer_TransferJob extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $creationTime;
  ...
  public $name;
  public $projectId;
  protected $scheduleType = 'Forminator_Google_Service_Storagetransfer_Schedule';
  protected $scheduleDataType = '';
  public $status;
  protected $transferSpecType = 'Forminator_Google_Service_Storagetransfer_TransferSpec';
  ...
  public function setSchedule(Forminator_Google_Service_Storagetransfer_Schedule $schedule)
  {
  ...
  public function setTransferSpec(Forminator_Google_Service_Storagetransfer_TransferSpec $transferSpec)
  {
...
class Forminator_Google_Service_Storagetransfer_TransferOperation extends Forminator_Google_Collection
{
  protected $collection_key = 'errorBreakdowns';
  protected $internal_gapi_mappings = array(
  );
  protected $countersType = 'Forminator_Google_Service_Storagetransfer_TransferCounters';
  protected $countersDataType = '';
  public $endTime;
  protected $errorBreakdownsType = 'Forminator_Google_Service_Storagetransfer_ErrorSummary';
  ...
  public function setCounters(Forminator_Google_Service_Storagetransfer_TransferCounters $counters)
  {
...
class Forminator_Google_Service_Storagetransfer_TransferOptions extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Storagetransfer_TransferSpec extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $awsS3DataSourceType = 'Forminator_Google_Service_Storagetransfer_AwsS3Data';
  protected $awsS3DataSourceDataType = '';
  protected $gcsDataSinkType = 'Forminator_Google_Service_Storagetransfer_GcsData';
  protected $gcsDataSinkDataType = '';
  protected $gcsDataSourceType = 'Forminator_Google_Service_Storagetransfer_GcsData';
  protected $gcsDataSourceDataType = '';
  protected $httpDataSourceType = 'Forminator_Google_Service_Storagetransfer_HttpData';
  protected $httpDataSourceDataType = '';
  protected $objectConditionsType = 'Forminator_Google_Service_Storagetransfer_ObjectConditions';
  protected $objectConditionsDataType = '';
  protected $transferOptionsType = 'Forminator_Google_Service_Storagetransfer_TransferOptions';
  protected $transferOptionsDataType = '';


  public function setAwsS3DataSource(Forminator_Google_Service_Storagetransfer_AwsS3Data $awsS3DataSource)
  {
  ...
  public function setGcsDataSink(Forminator_Google_Service_Storagetransfer_GcsData $gcsDataSink)
  {
  ...
  public function setGcsDataSource(Forminator_Google_Service_Storagetransfer_GcsData $gcsDataSource)
  {
  ...
  public function setHttpDataSource(Forminator_Google_Service_Storagetransfer_HttpData $httpDataSource)
  {
  ...
  public function setObjectConditions(Forminator_Google_Service_Storagetransfer_ObjectConditions $objectConditions)
  {
  ...
  public function setTransferOptions(Forminator_Google_Service_Storagetransfer_TransferOptions $transferOptions)
  {
...
class Forminator_Google_Service_Storagetransfer_UpdateTransferJobRequest extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $projectId;
  protected $transferJobType = 'Forminator_Google_Service_Storagetransfer_TransferJob';
  ...
  public function setTransferJob(Forminator_Google_Service_Storagetransfer_TransferJob $transferJob)
  {
