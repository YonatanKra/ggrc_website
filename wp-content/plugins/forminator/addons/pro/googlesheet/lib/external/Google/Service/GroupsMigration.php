 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_GroupsMigration extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->archive = new Forminator_Google_Service_GroupsMigration_Archive_Resource(
        $this,
        $this->serviceName,
        'archive',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $groupsmigrationService = new Forminator_Google_Service_GroupsMigration(...);
 *   $archive = $groupsmigrationService->archive;
 *  </code>
 */
class Forminator_Google_Service_GroupsMigration_Archive_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_GroupsMigration_Groups
   */
  public function insert($groupId, $optParams = array())
  {
    $params = array('groupId' => $groupId);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Forminator_Google_Service_GroupsMigration_Groups");
  }
}
...
class Forminator_Google_Service_GroupsMigration_Groups extends Forminator_Google_Model
{
