 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Webmasters extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->searchanalytics = new Forminator_Google_Service_Webmasters_Searchanalytics_Resource(
        $this,
        $this->serviceName,
        'searchanalytics',
        array(
    ...
    $this->sitemaps = new Forminator_Google_Service_Webmasters_Sitemaps_Resource(
        $this,
        $this->serviceName,
        'sitemaps',
        array(
    ...
    $this->sites = new Forminator_Google_Service_Webmasters_Sites_Resource(
        $this,
        $this->serviceName,
        'sites',
        array(
    ...
    $this->urlcrawlerrorscounts = new Forminator_Google_Service_Webmasters_Urlcrawlerrorscounts_Resource(
        $this,
        $this->serviceName,
    ...
    $this->urlcrawlerrorssamples = new Forminator_Google_Service_Webmasters_Urlcrawlerrorssamples_Resource(
        $this,
        $this->serviceName,
 ...
 * Typical usage is:
 *  <code>
 *   $webmastersService = new Forminator_Google_Service_Webmasters(...);
 *   $searchanalytics = $webmastersService->searchanalytics;
 *  </code>
 */
class Forminator_Google_Service_Webmasters_Searchanalytics_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param Forminator_Google_SearchAnalyticsQueryRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Webmasters_SearchAnalyticsQueryResponse
   */
  public function query($siteUrl, Forminator_Google_Service_Webmasters_SearchAnalyticsQueryRequest $postBody, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Forminator_Google_Service_Webmasters_SearchAnalyticsQueryResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Webmasters_Sitemaps_Resource extends Forminator_Google_Service_Resource
{
   ...
   * http://www.example.com/sitemap.xml
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Webmasters_WmxSitemap
   */
  public function get($siteUrl, $feedpath, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl, 'feedpath' => $feedpath);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Webmasters_WmxSitemap");
  }
   ...
   * @return Forminator_Google_Service_Webmasters_SitemapsListResponse
   */
  public function listSitemaps($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Webmasters_SitemapsListResponse");
  }
 ...
 *  </code>
 */
class Forminator_Google_Service_Webmasters_Sites_Resource extends Forminator_Google_Service_Resource
{
   ...
   * Examples: http://www.example.com/ or android-app://com.example/
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Webmasters_WmxSite
   */
  public function get($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Webmasters_WmxSite");
  }
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Webmasters_SitesListResponse
   */
  public function listSites($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Webmasters_SitesListResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Webmasters_Urlcrawlerrorscounts_Resource extends Forminator_Google_Service_Resource
{
   ...
   * platforms.
   * @return Forminator_Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse
   */
  public function query($siteUrl, $optParams = array())
  {
    $params = array('siteUrl' => $siteUrl);
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Forminator_Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Webmasters_Urlcrawlerrorssamples_Resource extends Forminator_Google_Service_Resource
{
   ...
   * For example: web
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Webmasters_UrlCrawlErrorsSample
   */
  public function get($siteUrl, $url, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Webmasters_UrlCrawlErrorsSample");
  }
   ...
   * For example: web
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse
   */
  public function listUrlcrawlerrorssamples($siteUrl, $category, $platform, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse");
  }
...
class Forminator_Google_Service_Webmasters_ApiDataRow extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Webmasters_ApiDimensionFilter extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $dimension;
...
class Forminator_Google_Service_Webmasters_ApiDimensionFilterGroup extends Forminator_Google_Collection
{
  protected $collection_key = 'filters';
  protected $internal_gapi_mappings = array(
  );
  protected $filtersType = 'Forminator_Google_Service_Webmasters_ApiDimensionFilter';
...
class Forminator_Google_Service_Webmasters_SearchAnalyticsQueryRequest extends Forminator_Google_Collection
{
  protected $collection_key = 'dimensions';
  protected $internal_gapi_mappings = array(
  );
  public $aggregationType;
  protected $dimensionFilterGroupsType = 'Forminator_Google_Service_Webmasters_ApiDimensionFilterGroup';
...
class Forminator_Google_Service_Webmasters_SearchAnalyticsQueryResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'rows';
  protected $internal_gapi_mappings = array(
  );
  public $responseAggregationType;
  protected $rowsType = 'Forminator_Google_Service_Webmasters_ApiDataRow';
...
class Forminator_Google_Service_Webmasters_SitemapsListResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'sitemap';
  protected $internal_gapi_mappings = array(
  );
  protected $sitemapType = 'Forminator_Google_Service_Webmasters_WmxSitemap';
...
class Forminator_Google_Service_Webmasters_SitesListResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'siteEntry';
  protected $internal_gapi_mappings = array(
  );
  protected $siteEntryType = 'Forminator_Google_Service_Webmasters_WmxSite';
...
class Forminator_Google_Service_Webmasters_UrlCrawlErrorCount extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $count;
...
class Forminator_Google_Service_Webmasters_UrlCrawlErrorCountsPerType extends Forminator_Google_Collection
{
  protected $collection_key = 'entries';
  protected $internal_gapi_mappings = array(
  );
  public $category;
  protected $entriesType = 'Forminator_Google_Service_Webmasters_UrlCrawlErrorCount';
...
class Forminator_Google_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'countPerTypes';
  protected $internal_gapi_mappings = array(
  );
  protected $countPerTypesType = 'Forminator_Google_Service_Webmasters_UrlCrawlErrorCountsPerType';
...
class Forminator_Google_Service_Webmasters_UrlCrawlErrorsSample extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  ...
  public $pageUrl;
  public $responseCode;
  protected $urlDetailsType = 'Forminator_Google_Service_Webmasters_UrlSampleDetails';
  ...
  public function setUrlDetails(Forminator_Google_Service_Webmasters_UrlSampleDetails $urlDetails)
  {
...
class Forminator_Google_Service_Webmasters_UrlCrawlErrorsSamplesListResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'urlCrawlErrorSample';
  protected $internal_gapi_mappings = array(
  );
  protected $urlCrawlErrorSampleType = 'Forminator_Google_Service_Webmasters_UrlCrawlErrorsSample';
...
class Forminator_Google_Service_Webmasters_UrlSampleDetails extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Webmasters_WmxSite extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Webmasters_WmxSitemap extends Forminator_Google_Collection
{
  protected $collection_key = 'contents';
  protected $internal_gapi_mappings = array(
  );
  protected $contentsType = 'Forminator_Google_Service_Webmasters_WmxSitemapContent';
...
class Forminator_Google_Service_Webmasters_WmxSitemapContent extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $indexed;
