 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Partners extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->clientMessages = new Forminator_Google_Service_Partners_ClientMessages_Resource(
        $this,
        $this->serviceName,
        'clientMessages',
        array(
    ...
    $this->companies = new Forminator_Google_Service_Partners_Companies_Resource(
        $this,
        $this->serviceName,
        'companies',
        array(
    ...
    $this->companies_leads = new Forminator_Google_Service_Partners_CompaniesLeads_Resource(
        $this,
        $this->serviceName,
        'leads',
        array(
    ...
    $this->userEvents = new Forminator_Google_Service_Partners_UserEvents_Resource(
        $this,
        $this->serviceName,
        'userEvents',
        array(
    ...
    $this->userStates = new Forminator_Google_Service_Partners_UserStates_Resource(
        $this,
        $this->serviceName,
        'userStates',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $partnersService = new Forminator_Google_Service_Partners(...);
 *   $clientMessages = $partnersService->clientMessages;
 *  </code>
 */
class Forminator_Google_Service_Partners_ClientMessages_Resource extends Forminator_Google_Service_Resource
{
   ...
   *
   * @param Forminator_Google_LogMessageRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Partners_LogMessageResponse
   */
  public function log(Forminator_Google_Service_Partners_LogMessageRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('log', array($params), "Forminator_Google_Service_Partners_LogMessageResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Partners_Companies_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Partners_GetCompanyResponse
   */
  public function get($companyId, $optParams = array())
  {
    $params = array('companyId' => $companyId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Partners_GetCompanyResponse");
  }
   ...
   * matched company. .
   * @return Forminator_Google_Service_Partners_ListCompaniesResponse
   */
  public function listCompanies($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Partners_ListCompaniesResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Partners_CompaniesLeads_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param Forminator_Google_CreateLeadRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Partners_CreateLeadResponse
   */
  public function create($companyId, Forminator_Google_Service_Partners_CreateLeadRequest $postBody, $optParams = array())
  {
    $params = array('companyId' => $companyId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Forminator_Google_Service_Partners_CreateLeadResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Partners_UserEvents_Resource extends Forminator_Google_Service_Resource
{

  /**
   * Logs a user event. (userEvents.log)
   *
   * @param Forminator_Google_LogUserEventRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Forminator_Google_Service_Partners_LogUserEventResponse
   */
  public function log(Forminator_Google_Service_Partners_LogUserEventRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('log', array($params), "Forminator_Google_Service_Partners_LogUserEventResponse");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Partners_UserStates_Resource extends Forminator_Google_Service_Resource
{
   ...
   * identifier to indicate where the traffic comes from. An identifier has
   * multiple letters created by a team which redirected the traffic to us.
   * @return Forminator_Google_Service_Partners_ListUserStatesResponse
   */
  public function listUserStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Forminator_Google_Service_Partners_ListUserStatesResponse");
  }
}
...
class Forminator_Google_Service_Partners_CertificationExamStatus extends Forminator_Google_Model
{
...
class Forminator_Google_Service_Partners_CertificationStatus extends Forminator_Google_Collection
{
  protected $collection_key = 'examStatuses';
  protected $internal_gapi_mappings = array(
  );
  protected $examStatusesType = 'Forminator_Google_Service_Partners_CertificationExamStatus';
...
class Forminator_Google_Service_Partners_Company extends Forminator_Google_Collection
{
  protected $collection_key = 'services';
  protected $internal_gapi_mappings = array(
  );
  protected $certificationStatusesType = 'Forminator_Google_Service_Partners_CertificationStatus';
  protected $certificationStatusesDataType = 'array';
  protected $convertedMinMonthlyBudgetType = 'Forminator_Google_Service_Partners_Money';
  protected $convertedMinMonthlyBudgetDataType = '';
  public $id;
  public $industries;
  protected $localizedInfosType = 'Forminator_Google_Service_Partners_LocalizedCompanyInfo';
  protected $localizedInfosDataType = 'array';
  protected $locationsType = 'Forminator_Google_Service_Partners_Location';
  protected $locationsDataType = 'array';
  public $name;
  protected $originalMinMonthlyBudgetType = 'Forminator_Google_Service_Partners_Money';
  protected $originalMinMonthlyBudgetDataType = '';
  protected $publicProfileType = 'Forminator_Google_Service_Partners_PublicProfile';
  protected $publicProfileDataType = '';
  protected $ranksType = 'Forminator_Google_Service_Partners_Rank';
  ...
  public function setConvertedMinMonthlyBudget(Forminator_Google_Service_Partners_Money $convertedMinMonthlyBudget)
  {
  ...
  public function setOriginalMinMonthlyBudget(Forminator_Google_Service_Partners_Money $originalMinMonthlyBudget)
  {
  ...
  public function setPublicProfile(Forminator_Google_Service_Partners_PublicProfile $publicProfile)
  {
...
class Forminator_Google_Service_Partners_CreateLeadRequest extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $leadType = 'Forminator_Google_Service_Partners_Lead';
  protected $leadDataType = '';
  protected $recaptchaChallengeType = 'Forminator_Google_Service_Partners_RecaptchaChallenge';
  protected $recaptchaChallengeDataType = '';
  protected $requestMetadataType = 'Forminator_Google_Service_Partners_RequestMetadata';
  protected $requestMetadataDataType = '';


  public function setLead(Forminator_Google_Service_Partners_Lead $lead)
  {
    $this->lead = $lead;
  }
  ...
  public function setRecaptchaChallenge(Forminator_Google_Service_Partners_RecaptchaChallenge $recaptchaChallenge)
  {
  ...
  public function setRequestMetadata(Forminator_Google_Service_Partners_RequestMetadata $requestMetadata)
  {
...
class Forminator_Google_Service_Partners_CreateLeadResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $leadType = 'Forminator_Google_Service_Partners_Lead';
  ...
  protected $responseMetadataType = 'Forminator_Google_Service_Partners_ResponseMetadata';
  ...
  public function setResponseMetadata(Forminator_Google_Service_Partners_ResponseMetadata $responseMetadata)
  {
...
class Forminator_Google_Service_Partners_DebugInfo extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $serverInfo;
...
class Forminator_Google_Service_Partners_EventData extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Partners_GetCompanyResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $companyType = 'Forminator_Google_Service_Partners_Company';
  protected $companyDataType = '';
  protected $responseMetadataType = 'Forminator_Google_Service_Partners_ResponseMetadata';
  protected $responseMetadataDataType = '';


  public function setCompany(Forminator_Google_Service_Partners_Company $company)
  {
...
class Forminator_Google_Service_Partners_LatLng extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $latitude;
...
class Forminator_Google_Service_Partners_Lead extends Forminator_Google_Collection
{
  ...
  public $id;
  protected $minMonthlyBudgetType = 'Forminator_Google_Service_Partners_Money';
  ...
  public function setMinMonthlyBudget(Forminator_Google_Service_Partners_Money $minMonthlyBudget)
  {
...
class Forminator_Google_Service_Partners_ListCompaniesResponse extends Forminator_Google_Collection
{
  protected $collection_key = 'companies';
  protected $internal_gapi_mappings = array(
  );
  protected $companiesType = 'Forminator_Google_Service_Partners_Company';
...
class Forminator_Google_Service_Partners_ListUserStatesResponse extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Partners_LocalizedCompanyInfo extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Partners_Location extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
  protected $latLngType = 'Forminator_Google_Service_Partners_LatLng';
  ...
  public function setLatLng(Forminator_Google_Service_Partners_LatLng $latLng)
  {
    $this->latLng = $latLng;
  }
...
class Forminator_Google_Service_Partners_LogMessageRequest extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $clientInfo;
...
class Forminator_Google_Service_Partners_LogMessageResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $responseMetadataType = 'Forminator_Google_Service_Partners_ResponseMetadata';
...
class Forminator_Google_Service_Partners_LogUserEventRequest extends Forminator_Google_Collection
{
  ...
  protected $eventDatasType = 'Forminator_Google_Service_Partners_EventData';
...
class Forminator_Google_Service_Partners_LogUserEventResponse extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $responseMetadataType = 'Forminator_Google_Service_Partners_ResponseMetadata';
...
class Forminator_Google_Service_Partners_Money extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $currencyCode;
...
class Forminator_Google_Service_Partners_PublicProfile extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Partners_Rank extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $type;
...
class Forminator_Google_Service_Partners_RecaptchaChallenge extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $id;
...
class Forminator_Google_Service_Partners_RequestMetadata extends Forminator_Google_Collection
{
  ...
  protected $trafficSourceType = 'Forminator_Google_Service_Partners_TrafficSource';
  protected $trafficSourceDataType = '';
  protected $userOverridesType = 'Forminator_Google_Service_Partners_UserOverrides';
  ...
  public function setTrafficSource(Forminator_Google_Service_Partners_TrafficSource $trafficSource)
  {
  ...
  public function setUserOverrides(Forminator_Google_Service_Partners_UserOverrides $userOverrides)
  {
...
class Forminator_Google_Service_Partners_ResponseMetadata extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  protected $debugInfoType = 'Forminator_Google_Service_Partners_DebugInfo';
  protected $debugInfoDataType = '';


  public function setDebugInfo(Forminator_Google_Service_Partners_DebugInfo $debugInfo)
  {
...
class Forminator_Google_Service_Partners_TrafficSource extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Partners_UserOverrides extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $ipAddress;
