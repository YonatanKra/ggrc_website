 ...
 * @author Google, Inc.
 */
class Forminator_Google_Service_Reports extends Forminator_Google_Service
{
  ...
  public function __construct(Forminator_Google_Client $client)
  {
    ...
    $this->activities = new Forminator_Google_Service_Reports_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
    ...
    $this->channels = new Forminator_Google_Service_Reports_Channels_Resource(
        $this,
        $this->serviceName,
        'channels',
        array(
    ...
    $this->customerUsageReports = new Forminator_Google_Service_Reports_CustomerUsageReports_Resource(
        $this,
        $this->serviceName,
    ...
    $this->userUsageReport = new Forminator_Google_Service_Reports_UserUsageReport_Resource(
        $this,
        $this->serviceName,
        'userUsageReport',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new Forminator_Google_Service_Reports(...);
 *   $activities = $adminService->activities;
 *  </code>
 */
class Forminator_Google_Service_Reports_Activities_Resource extends Forminator_Google_Service_Resource
{
   ...
   * time.
   * @return Forminator_Google_Service_Reports_Activities
   */
  public function listActivities($userKey, $applicationName, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "Forminator_Google_Service_Reports_Activities");
  }
   ...
   * @opt_param string startTime Return events which occured at or after this
   * time.
   * @return Forminator_Google_Service_Reports_Channel
   */
  public function watch($userKey, $applicationName, Forminator_Google_Service_Reports_Channel $postBody, $optParams = array())
  {
    $params = array('userKey' => $userKey, 'applicationName' => $applicationName, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('watch', array($params), "Forminator_Google_Service_Reports_Channel");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Reports_Channels_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   */
  public function stop(Forminator_Google_Service_Reports_Channel $postBody, $optParams = array())
  {
 ...
 *  </code>
 */
class Forminator_Google_Service_Reports_CustomerUsageReports_Resource extends Forminator_Google_Service_Resource
{
   ...
   * @return Forminator_Google_Service_Reports_UsageReports
   */
  public function get($date, $optParams = array())
  {
    $params = array('date' => $date);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Forminator_Google_Service_Reports_UsageReports");
  }
}
 ...
 *  </code>
 */
class Forminator_Google_Service_Reports_UserUsageReport_Resource extends Forminator_Google_Service_Resource
{
...
class Forminator_Google_Service_Reports_Activities extends Forminator_Google_Collection
{
  protected $collection_key = 'items';
  protected $internal_gapi_mappings = array(
  );
  public $etag;
  protected $itemsType = 'Forminator_Google_Service_Reports_Activity';
...
class Forminator_Google_Service_Reports_Activity extends Forminator_Google_Collection
{
  protected $collection_key = 'events';
  protected $internal_gapi_mappings = array(
  );
  protected $actorType = 'Forminator_Google_Service_Reports_ActivityActor';
  protected $actorDataType = '';
  public $etag;
  protected $eventsType = 'Forminator_Google_Service_Reports_ActivityEvents';
  protected $eventsDataType = 'array';
  protected $idType = 'Forminator_Google_Service_Reports_ActivityId';
  ...
  public function setActor(Forminator_Google_Service_Reports_ActivityActor $actor)
  {
    $this->actor = $actor;
  }
  ...
  public function setId(Forminator_Google_Service_Reports_ActivityId $id)
  {
    $this->id = $id;
  }
...
class Forminator_Google_Service_Reports_ActivityActor extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $callerType;
...
class Forminator_Google_Service_Reports_ActivityEvents extends Forminator_Google_Collection
{
  protected $collection_key = 'parameters';
  protected $internal_gapi_mappings = array(
  );
  public $name;
  protected $parametersType = 'Forminator_Google_Service_Reports_ActivityEventsParameters';
...
class Forminator_Google_Service_Reports_ActivityEventsParameters extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Reports_ActivityId extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
...
class Forminator_Google_Service_Reports_Channel extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $address;
...
class Forminator_Google_Service_Reports_UsageReport extends Forminator_Google_Collection
{
  protected $collection_key = 'parameters';
  protected $internal_gapi_mappings = array(
  );
  public $date;
  protected $entityType = 'Forminator_Google_Service_Reports_UsageReportEntity';
  protected $entityDataType = '';
  public $etag;
  public $kind;
  protected $parametersType = 'Forminator_Google_Service_Reports_UsageReportParameters';
  protected $parametersDataType = 'array';
  ...
  public function setEntity(Forminator_Google_Service_Reports_UsageReportEntity $entity)
  {
    $this->entity = $entity;
  }
...
class Forminator_Google_Service_Reports_UsageReportEntity extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $customerId;
...
class Forminator_Google_Service_Reports_UsageReportParameters extends Forminator_Google_Collection
{
...
class Forminator_Google_Service_Reports_UsageReports extends Forminator_Google_Collection
{
  ...
  public $kind;
  public $nextPageToken;
  protected $usageReportsType = 'Forminator_Google_Service_Reports_UsageReport';
  protected $usageReportsDataType = 'array';
  protected $warningsType = 'Forminator_Google_Service_Reports_UsageReportsWarnings';
...
class Forminator_Google_Service_Reports_UsageReportsWarnings extends Forminator_Google_Collection
{
  protected $collection_key = 'data';
  protected $internal_gapi_mappings = array(
  );
  public $code;
  protected $dataType = 'Forminator_Google_Service_Reports_UsageReportsWarningsData';
...
class Forminator_Google_Service_Reports_UsageReportsWarningsData extends Forminator_Google_Model
{
  protected $internal_gapi_mappings = array(
  );
  public $key;
