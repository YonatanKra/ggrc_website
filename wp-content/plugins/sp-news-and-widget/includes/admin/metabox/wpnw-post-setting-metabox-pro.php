...
?>
<div class="pro-notice"><?php echo sprintf( __( 'Upgrade to <a href="%s" target="_blank">Pro Version</a> with Essential Plugin Bundle to boost your <b style="color:#FF5D52;">web site, landing pages & conversions</b>.', 'sp-news-and-widget'), WPNW_PLUGIN_LINK); ?></div>
