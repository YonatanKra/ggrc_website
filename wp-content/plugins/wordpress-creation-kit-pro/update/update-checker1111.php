<?php
if ( !class_exists('wck_PluginUpdateChecker') ):
...
class PluginUpdate {
	...
	public function toWpFormat(){
        ...
        //add an icon to the update screen for the pro version (this is specific to WCK, don't have a good solution for making it global)
        $update->icons = array( "2x" =>"https://ps.w.org/wck-custom-fields-and-custom-post-types-creator/assets/icon-256x256.png?rev=1077372");
