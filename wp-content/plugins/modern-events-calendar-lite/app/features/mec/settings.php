                ...
                <div class="mec-container">
                    ...
                    <form id="mec_settings_form">
                        ...
                        <div id="assets_per_page_option" class="mec-options-fields">
                            <h4 class="mec-form-subtitle"><?php _e('Assets (CSS and JavaScript files)', 'modern-events-calendar-lite'); ?></h4>
                            
                            <h5 class="title"><?php _e('Per Page', 'modern-events-calendar-lite'); ?></h5>
                            <div class="mec-form-row">
                                <label>
                            ...
                            <h5 class="title"><?php _e('Load in Footer', 'modern-events-calendar-lite'); ?></h5>
                            <div class="mec-form-row">
                                <label>
                                    <input type="hidden" name="mec[settings][assets_in_footer_status]" value="0" />
                                    <input value="1" type="checkbox" name="mec[settings][assets_in_footer_status]" <?php if(isset($settings['assets_in_footer_status']) and $settings['assets_in_footer_status']) echo 'checked="checked"'; ?> /> <?php _e('Load Assets in Footer', 'modern-events-calendar-lite'); ?>
                                </label>
                            </div>                            
                        </div>
                        ...
                        <div id="fes_option" class="mec-options-fields">
                            ...
                            <div class="mec-form-row">
                                <label>
                                    ...
                                    <input value="1" type="checkbox" name="mec[settings][fes_section_countdown_method]" <?php if(!isset($settings['fes_section_countdown_method']) or (isset($settings['fes_section_countdown_method']) and $settings['fes_section_countdown_method'])) echo 'checked="checked"'; ?> /> <?php _e('Countdown Method', 'modern-events-calendar-lite'); ?>
                                </label>
                            </div>
                            <div class="mec-form-row">
                                <label>
