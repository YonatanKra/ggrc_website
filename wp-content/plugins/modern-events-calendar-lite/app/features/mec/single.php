                ...
                <div class="mec-container">
                    ...
                    <form id="mec_single_form">
                        ...
                        <div id="event_options" class="mec-options-fields active">
                            ...
                            <div class="mec-form-row">
                                <label class="mec-col-3" for="mec_settings_public_download_module"><?php _e('Public Download Module', 'modern-events-calendar-lite'); ?></label>
                                <div class="mec-col-9">
                                    <label for="mec_settings_public_download_module">
                                        <input type="hidden" name="mec[settings][public_download_module]" value="0" />
                                        <input type="checkbox" name="mec[settings][public_download_module]" id="mec_settings_public_download_module" <?php echo ((isset($settings['public_download_module']) and $settings['public_download_module'] == '1') ? 'checked="checked"' : ''); ?> value="1" /><?php _e('Enable', 'modern-events-calendar-lite'); ?>
                                    </label>
                                    <span class="mec-tooltip">
                                        <div class="box left">
                                            <h5 class="title"><?php _e('Public Download Module', 'modern-events-calendar-lite'); ?></h5>
