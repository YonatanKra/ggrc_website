...
$comment_position = $comment_position ? $comment_position : 'before';
...
<section id="comments" class="<?php echo esc_attr( $classes ); ?>">
	...
	if ( have_comments() ) :
		...
		if ( '1' === $comments_number ) {
			$comments_title = esc_html__( 'Comments (1)', 'oceanwp' );
		} else {
			/* translators: %s: Comments number */
			$comments_title = sprintf( esc_html__( 'Comments (%s)', 'oceanwp' ), $comments_number );
		}
