            	...
            	<div class="col-lg-9 col-md-12 col-sm-12">
            		<div class="row">
            			<div class="col-lg-9 col-md-9 col-sm-12">
							...
							?>
							<br>
							<button class="ggrc-btn-white-md mt-60"><a href="<?php echo get_post_meta( get_the_ID(), 'mec_more_info', true) ?>" target="_blank"><h3 class="m-0">More Information</h3></a></button>
            			...
            			<div class="col-lg-3 col-md-3 col-sm-12 mt-60" id="event-details">
            				...
            				<h4 class="m-0 mt-20">Where</h4>
            				<?php
            					$single->display_location_widget($single_event_obj); 
            				?>
            				<h4 class="m-0 mt-20">Time</h4>
            				<?php
            						$single->display_time_widget($single_event_obj);
            				?>
            				<h4 class="m-0 mt-20">Participation cost</h4>
            				<?php
