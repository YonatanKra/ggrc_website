								...
								<div class="col-md-6 col-lg-6 col-sm-12">
									<div class="row">
										<div class="col-md-12 col-lg-12 col-sm-12 align-center">
											<h2 class="m-0">How to Take Action:</h2>
										</div>
									</div>
								</div>
								...
								<?php 
									...
									<div class="col-md-4 col-lg-4 col-sm-12" id="initiative-contact">
										<div class="initiative-contact-details">
											...
											<p class="m-0"><?php the_field('initiative-contact-title-'. $i) ?></p>
											<p class="m-0"><?php the_field('initiative-contact-organisation-'. $i) ?></p>
											<i class="ggrc-icon ggrc-message"></i> <p class="m-0 inline-display"><a href="mailto:<?php the_field('initiative-contact-email-'. $i) ?>"><?php the_field('initiative-contact-email-'. $i) ?></a></p>
										</div>
						...
						if(empty($initiative_updates) || ! is_array($initiative_updates)){
							...
							<div class="row">
								...
								foreach($initiative_updates[0] as $initiative_update){
									...
									?>
									<p class="m-0 links"><?php echo date('F j, Y', strtotime($initiative_update['UpdateDate'])); ?></p>
									<h3 class="m-0"><?php echo $initiative_update['UpdateTitle']; ?></h3>								
