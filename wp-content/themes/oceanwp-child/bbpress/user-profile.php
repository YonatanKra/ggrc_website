...
<style>
	...
	<div id="bbp-user-wrapper">
		...
		<div class="row">
			...
			<?php do_action( 'bbp_template_before_user_details' ); ?>
				<div id="bbp-single-user-details">
					...
					<div class="align-center">
						<h4 class="mb-0"><?php bbp_displayed_user_field( 'display_name' ); ?></h4>
						<p class="mb-0"><?php bbp_displayed_user_field( 'job_title' ); ?></p>
			...
			<h4 class="mb-0">Content by <?php bbp_displayed_user_field( 'display_name' ); ?></h4>
        	<hr/>
