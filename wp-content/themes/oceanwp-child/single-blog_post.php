	...
	<div id="content-wrap" class="container clr">
		...
		<div id="primary" class="content-area clr" >
			...
			<div class="blog-details">
				...
				<hr/>
				<div>
					<p class="like-share">Published : <?php the_time('F j, Y'); ?></p> <p class="like-share"> <i class="ggrc-icon heart"></i> 2 Likes</p> <p class="like-share"><i class="ggrc-icon share-1"></i> 5 Shares</p>
				</div>
				<hr/>
			</div>
