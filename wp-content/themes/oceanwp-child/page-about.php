						...
						<div class="row mb-60">
							<div class="col-lg-4 col-md-6 col-sm-12 mt-100">
								<div class="team-blocks">
									...
									<h4 class="align-center mt-80 no-margin-bottom">Rosalind Helfand</h4>
									<p class="align-center links"><em>Co-Lead</em></p>
									<p class="align-center"><b>United States</b></p>
									<p class="accordion no-margin-bottom">Read Bio </p>
									<div class="panel">
							...
							<div class="col-lg-4 col-md-6 col-sm-12 mt-100">
								<div class="team-blocks">
									...
									<h4 class="align-center mt-80 no-margin-bottom">Ravikash Prasad</h4>
									<p class="align-center links"><em>Co-Lead</em></p>
